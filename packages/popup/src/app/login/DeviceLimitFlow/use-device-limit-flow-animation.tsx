...
export type DeviceLimitFlowAnimationCallback = (
  setPhase: (next: DeviceLimitFlowAnimationPhase) => void
) => void;
...
export const useDeviceLimitFlowAnimation = ({
  loop,
  advanced,
}: UseDeviceLimitFlowAnimationParams) => {
  const [phase, startPhase] = React.useState<DeviceLimitFlowAnimationPhase>(
