...
const DeviceLimitFlow = ({ setIsInitialSyncAnimationPending, onStartOver, }: DeviceLimitFlowProps) => {
    ...
    switch (stage.name) {
        ...
        case LoginDeviceLimitFlowStage.OneDeviceLimitReached:
            return (<OneDeviceLimitStep previousDevice={stage.previousDevice} onStartOver={onStartOver}/>);
        case LoginDeviceLimitFlowStage.MultipleDevicesLimitReached:
            return (<MultipleDevicesLimitStep onStartOver={onStartOver} subscriptionCode={stage.subscriptionCode}/>);
        case LoginDeviceLimitFlowStage.UnlinkingAndOpeningSession:
        case LoginDeviceLimitFlowStage.DeviceLimitDone:
            return (<InitialSyncProgressStep stage={stage} setIsInitialSyncAnimationPending={setIsInitialSyncAnimationPending}/>);
