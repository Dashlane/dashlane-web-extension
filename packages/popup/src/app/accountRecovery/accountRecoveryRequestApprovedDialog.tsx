...
export const AccountRecoveryRequestApprovedDialog: React.FunctionComponent<Props> = ({ isVisible, onRecoverUserAccount }: Props) => {
    const { translate } = useTranslate();
    return (<Dialog confirmLabel={translate(I18N_KEYS.CONFIRM)} onConfirm={onRecoverUserAccount} visible={isVisible}>
      <div className={styles.icon}>
        <AllGoodIcon size={62} color="ds.container.expressive.brand.catchy.idle"/>
      </div>
