...
export const AccountRecoveryRequestPendingDialog: React.FunctionComponent<
  Props
> = ({ onCancelOrSendNew, onDismiss, isVisible, action = "cancel" }: Props) => {
  ...
  return (
    <Dialog
      ...
      onCancel={onCancelOrSendNew}
      visible={isVisible}
    >
      <div className={styles.icon}>
        <ClockOutlinedIcon
          size={62}
          color="ds.container.expressive.neutral.catchy.idle"
        />
      </div>
