...
export const AccountRecoveryRequestRefusedDialog: React.FunctionComponent<Props> = ({ onSendNewRequest, onDismiss, isVisible }: Props) => {
    const { translate } = useTranslate();
    return (<Dialog confirmLabel={translate(I18N_KEYS.CONFIRM)} onConfirm={onDismiss} cancelLabel={translate(I18N_KEYS.CLOSE)} onCancel={onSendNewRequest} visible={isVisible}>
      <div className={styles.icon}>
        <CrossCircleIcon size={62} color="ds.container.expressive.danger.catchy.idle"/>
      </div>
