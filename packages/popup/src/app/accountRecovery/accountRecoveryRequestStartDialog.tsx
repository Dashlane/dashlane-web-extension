...
export const AccountRecoveryRequestStartDialog: React.FunctionComponent<Props> = ({ onStartAccountRecovery, onDismiss, isVisible }: Props) => {
    const { translate } = useTranslate();
    return (<Dialog confirmLabel={translate(I18N_KEYS.CONFIRM)} onConfirm={onStartAccountRecovery} cancelLabel={translate(I18N_KEYS.CANCEL)} onCancel={onDismiss} visible={isVisible} autoFocusAction="confirm">
