...
const GeneratorSliderComponent = ({
  length,
  onLengthChanged,
  isDisabled,
}: Props) => {
  ...
  return (
    <div
      ...
      aria-valuetext={translate(I18N_KEYS.PASSWORD_LENGTH, {
    ...
    >
      <Slider
        id="passwordLengthString"
        aria-label={translate(I18N_KEYS.PASSWORD_LENGTH_TITLE)}
        label={translate(I18N_KEYS.PASSWORD_LENGTH, {
          length: passwordLength,
        })}
        min={4}
        max={40}
