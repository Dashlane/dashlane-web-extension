...
export const parseSubtitleTranslation = (
  translation: string,
  domain: string
): JSX.Element => {
...
export const GeneratedPasswordRow: React.FC<GeneratedPasswordRowProps> =
  React.memo(function GeneratedPasswordRow({ generatedPassword, onCopy }) {
        ...
        openProtectedItemsUnlocker({
          ...
          onSuccess: () =>
            onCopy(
              password,
              id,
              domain === DOMAIN_IS_GENERATOR_TAB ? undefined : domain
            ),
          showNeverAskOption: false,
          credentialId: id,
        });
      ...
      <div className={styles.generatedPassword}>
        ...
        <div className={styles.actions}>
          <IconButtonWithTooltip
            aria-label={displayPassword ? "hide" : "show"}
            tooltipContent={translate(
              displayPassword ? I18N_KEYS.HIDE : I18N_KEYS.SHOW
            )}
            icon={displayPassword ? <HideIcon /> : <RevealIcon />}
            onClick={togglePassword}
          />

          <IconButtonWithTooltip
            aria-label={"copyPassword"}
            tooltipContent={translate(I18N_KEYS.COPY_PASSWORD)}
