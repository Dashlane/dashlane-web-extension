...
export const Gauge = ({ score }: GaugeProps) => {
    ...
    useEffect(() => {
        setProgress((TOTAL_PATH_LENGTH / (MAX_SCORE - MIN_SCORE)) *
            (MAX_SCORE - MIN_SCORE - score));
    }, [score]);
    return (<svg xmlns="*****" width="100" height="120" fill="none" viewBox="0 0 200 153">
      <mask id="animatedMask">
        <path sx={{ transition: 'stroke-dashoffset 1s ease-in-out' }} strokeDasharray={TOTAL_PATH_LENGTH} strokeDashoffset={progress} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" stroke="white" d="M18.594 147a94 94 0 11162.827-.025"/>
      </mask>
      ...
      <path sx={{
        ...
        }} opacity="1" strokeDasharray={TOTAL_PATH_LENGTH} strokeDashoffset={progress} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" d="M18.594 147a94 94 0 11162.827-.025"/>
    </svg>);
};
