...
export const ChangeMasterPasswordSuccess = ({ onDone }: Props) => {
    ...
    return (<Progress description={translate(I18N_KEYS.DESCRIPTION)} icon={<CheckCircleIcon color={colors.midGreen04} size={64}/>} actionButtonText={translate(I18N_KEYS.BUTTON_DONE)} handleAction={onDone}/>);
};
