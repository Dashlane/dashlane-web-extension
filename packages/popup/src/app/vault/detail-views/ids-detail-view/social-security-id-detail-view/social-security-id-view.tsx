...
const SocialSecurityIdDetailViewComponent = ({ onClose, itemId }: Props) => {
    ...
    return (<>
      <SocialSecurityIdDetailHeader name={socialSecurityId.idName} id={socialSecurityId.id} onClose={onClose}/>
      <SocialSecurityIdDetailForm socialSecurityId={socialSecurityId}/>
    </>);
};
export const SocialSecurityIdDetailView = memo(SocialSecurityIdDetailViewComponent);
