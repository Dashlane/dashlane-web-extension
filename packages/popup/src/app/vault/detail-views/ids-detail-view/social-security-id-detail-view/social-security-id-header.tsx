...
const SocialSecurityIdDetailHeaderComponent = ({
  name,
  id,
  onClose,
}: Props) => (
  <Header
    Icon={<SocialSecurityIdIcon />}
    title={name}
    onEdit={() => {
...
export const SocialSecurityIdDetailHeader = memo(
  SocialSecurityIdDetailHeaderComponent
);
