...
import { PaymentCardIcon } from "../../active-tab-list/lists/payments-list/payment-cards/payment-card-icon/payment-card-icon";
...
const PaymentCardDetailHeaderComponent = ({
  card,
  onClose,
}: PaymentCardDetailHeaderProps) => (
  <Header
    Icon={<PaymentCardIcon paymentCardColor={card.color} />}
    title={card.itemName}
    onEdit={() => {
