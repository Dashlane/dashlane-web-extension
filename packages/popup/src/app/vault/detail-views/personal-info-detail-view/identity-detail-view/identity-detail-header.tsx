...
import { IdentityIcon } from 'src/app/vault/active-tab-list/lists/personal-info-list/identities/identity-icon';
...
const IdentityDetailHeaderComponent = ({ identity, onClose, }: IdentityDetailHeaderProps) => {
    ...
    return (<Header Icon={<IdentityIcon />} title={fullName} onEdit={() => {
