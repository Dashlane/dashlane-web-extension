...
export const I18N_KEYS = {
    PHONE_NUMBER_LABEL: 'tab/all_items/personal_info/phone/detail_view/label/phone_number',
...
export const I18N_ACTION_KEYS = {
    NUMBER_COPY: 'tab/all_items/personal_info/phone/detail_view/actions/copy_number',
    NUMBER_COPIED: 'tab/all_items/personal_info/phone/detail_view/actions/number_copied_to_clipboard',
};
export const I18N_PHONE_TYPES = {
    ...
    WORK_MOBILE: 'tab/all_items/personal_info/phone/detail_view/types/work_mobile',
    WORK_LANDLINE: 'tab/all_items/personal_info/phone/detail_view/types/work_landline',
...
const PhoneFormComponent = ({ phone }: Props) => {
    ...
    return (<FormContainer>
      {phoneNumber && (<Input id="phoneNumber" inputType="text" label={translate(I18N_KEYS.PHONE_NUMBER_LABEL)} value={phoneNumber} readonly actions={<CopyIconButton text={translate(I18N_ACTION_KEYS.NUMBER_COPY)} copyAction={() => {
                    void numberCopyAction();
                }}/>}/>)}
      {itemName && (<Input id="phoneName" inputType="text" label={translate(I18N_KEYS.NAME_LABEL)} value={itemName} readonly/>)}
      {type && (<Input id="phoneType" inputType="text" label={translate(I18N_KEYS.TYPE_LABEL)} value={getPhoneTypeOptions(type)} readonly/>)}
      {spaceId && (<SpaceName id="phoneSpace" label={translate(I18N_KEYS.SPACE_LABEL)} spaceId={spaceId}/>)}
    </FormContainer>);
};
