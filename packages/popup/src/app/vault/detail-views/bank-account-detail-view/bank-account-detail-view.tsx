...
const BankAccountDetailViewComponent = ({ onClose, itemId, }: BankAccountDetailViewComponentProps) => {
    ...
    return (<>
      <BankAccountDetailHeader name={bankAccount.accountName} id={bankAccount.id} onClose={onClose}/>
