...
export const PaymentFailureChurnedComponent: React.FC<PaymentFailureChurnedAlertProps> = ({ onClick, onDismiss }) => {
    ...
    return (<InfoBox size="descriptive" title={translate(I18N_KEYS.TITLE)} className={styles.alert} actions={[
...
export const PaymentFailureChurnedAlert = React.memo(PaymentFailureChurnedComponent);
