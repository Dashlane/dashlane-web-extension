...
const UTM_SOURCE_CODE = 'button:buy_dashlane+click_origin:banner_password_limit_reached+origin_page:item/credential/list+origin_component:extension_popup';
const I18N_KEYS = {
...
export const PasswordLimitReachedAlert = () => {
    ...
    const goToCheckout = () => {
        const buyDashlaneLink = `${GET_PREMIUM_URL}?subCode=${subscriptionCode ?? ''}&utm_source=${UTM_SOURCE_CODE}`;
    ...
    return (<Infobox sx={{ margin: '8px' }} title={translate(I18N_KEYS.PASSWORD_LIMIT_REACHED_TITLE)} mood="warning" size="large" icon="FeedbackWarningOutlined" actions={[
