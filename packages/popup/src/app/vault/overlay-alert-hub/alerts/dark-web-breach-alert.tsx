...
import { markBreachesAsViewed } from "../../../../libs/api";
...
export const DarkWebBreachAlert = ({
  pendingBreaches,
  onClick,
  onDismiss,
}: DarkWebAlertProps) => {
  ...
  return (
    <Dialog
      cancelLabel={translate(I18N_KEYS.DIALOG_ACTION_DISMISS)}
      confirmLabel={translate(I18N_KEYS.DIALOG_ACTION_VIEW)}
      onCancel={onCancel}
      onConfirm={() => {
        void onConfirm();
      }}
