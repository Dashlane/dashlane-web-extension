...
export const PaymentCardIcon = (props: Props) => {
  ...
  const backgroundColor = getBackgroundColorForPaymentCard(
    props.paymentCardColor
  );
  return (
    <Flex
      alignItems="center"
    ...
    >
      <CardIcon
        fill={isCardWhite ? colors.grey04 : backgroundColor}
        color={isCardWhite ? colors.black : colors.white}
      />
    </Flex>
  );
};
