...
export const PaymentsListContainer = () => {
    ...
    const totalItemsCount = bankAccountsResult.matchCount + paymentCardsResult.matchCount;
    SearchEventLogger.totalCount = totalItemsCount;
    return (<BaseListContainer hasItems={totalItemsCount > 0} vaultTabType={VaultTabType.Payments}>
