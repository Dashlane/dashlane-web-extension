...
const I18N_KEYS = {
  ...
  COPY_NOTE_SUCCESS:
    "tab/all_items/paymentCard/actions/note_copied_to_clipboard",
};
interface Props {
    ...
    >
      <>
        <ProtectedCopyDropdownElement
          ...
          copyValue={paymentCard.cardNumber}
          field={Field.CardNumber}
          I18N_KEY_text={I18N_KEYS.COPY_CARD_NUMBER}
          I18N_KEY_notification={I18N_KEYS.COPY_CARD_NUMBER_SUCCESS}
        />
        <ProtectedCopyDropdownElement
          {...defaultCopyDropdownElementProps}
          copyValue={paymentCard.securityCode}
          field={Field.SecurityCode}
          I18N_KEY_text={I18N_KEYS.COPY_SECURITY_CODE}
          I18N_KEY_notification={I18N_KEYS.COPY_SECURITY_CODE_SUCCESS}
        />
        <ProtectedCopyDropdownElement
          {...defaultCopyDropdownElementProps}
          copyValue={paymentCard.note}
          field={Field.Note}
          I18N_KEY_text={I18N_KEYS.COPY_NOTE}
          I18N_KEY_notification={I18N_KEYS.COPY_NOTE_SUCCESS}
        />
      </>
    </ActionsDropdown>
  );
