...
import { BankIcon, colors, IdIcon, NotesIcon, PasswordsIcon, PersonalInfoIcon, } from '@dashlane/ui-components';
...
const getKey = (vaultTabType: VaultTabType) => vaultTabType === VaultTabType.Credentials
    ? I18N_KEYS.NO_CREDENTIALS_PLACEHOLDER
    : I18N_KEYS.NO_ITEMS_PLACEHOLDER;
export const EmptyVaultItemsList = ({ vaultTabType, }: EmptyVaultItemsListProps) => {
    const { translate } = useTranslate();
    const vaultIcons: Record<VaultTabType, JSX.Element> = {
        [VaultTabType.Credentials]: (<PasswordsIcon size={96} color={colors.grey04}/>),
        ...
        [VaultTabType.PersonalInformation]: (<PersonalInfoIcon size={96} color={colors.grey04}/>),
    };
    return (<div className={styles.emptyVaultItemsList}>
