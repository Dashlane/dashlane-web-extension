...
import { Query, Route } from "@dashlane/framework-infra/spi";
...
const I18N_KEYS = {
  ...
  ADD_SECURE_NOTE_ADVICE:
    "tab/all_items/no_search_results_placeholder_secure_note",
  ADD_PAYMENT_CTA: "tab/all_items/no_search_results_add_payment_button",
  ADD_PAYMENT_ADVICE:
    "tab/all_items/no_search_results_placeholder_payment_item",
  NO_RESULTS_FOR_QUERY:
    "tab/all_items/no_search_results_placeholder_no_results",
...
export const NoResultsVaultItemsList = ({
  vaultTabType,
  searchValue,
}: Props) => {
  ...
  return (
    <article className={styles.searchMessage}>
