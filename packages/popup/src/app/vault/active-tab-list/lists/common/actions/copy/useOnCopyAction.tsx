...
import { vaultItemTypeToHermesItemTypeMap } from "../../../../../../helpers";
import { useUIStateStorageRepositoryContext } from "../../../../../../UIState/ui-state-storage-repository-context";
import { useAlertAutofillEngine } from "../../../../../../use-autofill-engine";
import { ActiveItemDetail } from "../../../../../detail-views/vault-item-detail-view-provider";
export function useOnCopyAction() {
  ...
  const onCopyAction = async (
    ...
    saveData(
      ...
      new ActiveItemDetail(itemType, credentialId)
    );
  };
  return onCopyAction;
}
