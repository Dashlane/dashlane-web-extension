...
const SecondaryLoginDropdownElement = ({
  ...
  return (
    <CopyDropdownElement
      copyValue={credentialData.data.secondaryLogin}
      credentialId={credentialId}
      field={Field.SecondaryLogin}
      I18N_KEY_text={I18N_KEYS.COPY_SECONDARY_LOGIN}
      I18N_KEY_notification={I18N_KEYS.SECONDARY_LOGIN_COPIED_TO_CLIPBOARD}
