...
import {
  LoginAndEmailDropdownElement,
  OTPDropdownElement,
  PasswordDropdownElement,
  SecondaryLoginDropdownElement,
...
export const CopyDropdownAction = ({
  credential,
  isDropdownOpen,
  setIsDropdownOpen,
}: CopyDropdownActionProps) => {
  const isDisabled =
    !credential.password && !credential.email && !credential.username;
  return (
    <ActionsDropdown
