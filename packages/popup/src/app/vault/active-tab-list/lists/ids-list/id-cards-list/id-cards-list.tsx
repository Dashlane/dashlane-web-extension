...
export const IdCardsList = ({ idCardsResult }: Props) => (
  <VaultItemsList
    ItemComponent={IdCardListItem}
    items={idCardsResult.items}
    titleKey={"tab/all_items/ids/id_card/title"}
    totalItemsCount={idCardsResult.matchCount}
  />
);
