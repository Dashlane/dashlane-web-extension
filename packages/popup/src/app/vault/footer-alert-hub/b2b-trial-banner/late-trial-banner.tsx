...
const I18N_KEYS = {
    ...
    STATUS_BUSINESS_FREE_TRIAL_1_DAY: 'tab/all_items/trial_banner/status_business_free_trial_1_day_markup',
    STATUS_TEAM_FREE_TRIAL_N_DAYS: 'tab/all_items/trial_banner/status_team_free_trial_n_days_markup',
    STATUS_TEAM_FREE_TRIAL_1_DAY: 'tab/all_items/trial_banner/status_team_free_trial_1_day_markup',
...
const getKeyBasedOnDaysRemaining = (daysRemaining: number, singularKey: string, pluralKey: string) => {
    return daysRemaining === 1 ? singularKey : pluralKey;
};
export const LateTrialBanner = ({ daysLeftInTrial, isBusiness, url, }: Props) => {
    const { translate, translateMarkup } = useTranslate();
    const statusCopy = translateMarkup(isBusiness
        ? getKeyBasedOnDaysRemaining(daysLeftInTrial, I18N_KEYS.STATUS_BUSINESS_FREE_TRIAL_1_DAY, I18N_KEYS.STATUS_BUSINESS_FREE_TRIAL_N_DAYS)
        : getKeyBasedOnDaysRemaining(daysLeftInTrial, I18N_KEYS.STATUS_TEAM_FREE_TRIAL_1_DAY, I18N_KEYS.STATUS_TEAM_FREE_TRIAL_N_DAYS), { count: daysLeftInTrial });
