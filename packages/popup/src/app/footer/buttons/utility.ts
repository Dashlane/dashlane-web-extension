import { FooterAction } from "../../../libs/sendLog/types";
import { TabName } from "../../vault/tabs-bar/active-vault-type-tab-context";
const I18N_KEYS = {
...
export const getAddNewInfo = (tabName: TabName): IAddNewInfo =>
  addNewInfoDictionary[tabName] || addNewInfoDictionary.passwords;
