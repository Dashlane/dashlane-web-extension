...
import loadingAnimationData from 'src/animation-data/sync/loading.json';
import successAnimationData from 'src/animation-data/sync/success.json';
import failureAnimationData from 'src/animation-data/sync/failure.json';
...
type SyncAnimationConfigWithData = Omit<AnimationConfigWithData, 'container' | 'animationData'> & {
...
export const SyncButton = () => {
    ...
    return (<Button title={translate(I18N_KEYS.MANUAL_SYNC_TOOLTIP)} aria-label={translate(I18N_KEYS.MANUAL_SYNC_TOOLTIP)} mood="neutral" layout="iconOnly" icon={<div sx={SX_STYLES.CONTAINER} ref={container}/>} intensity="supershy" onClick={handleManualSync} disabled={isSyncInProgress} ref={syncButtonRef}/>);
};
