...
import { Button, Flex, jsx, Paragraph } from "@dashlane/design-system";
import { useAnalyticsCommands } from "@dashlane/framework-react";
import { Result } from "@dashlane/framework-types";
import { PageView } from "@dashlane/hermes";
import { CrossCircleIcon, LoadingIcon } from "@dashlane/ui-components";
    ...
    >
      ...
      {!error && isCarbonActive ? (
        <LoadingIcon
          ...
          size="80px"
          sx={{ marginTop: "29px", marginBottom: "21px" }}
      ...
      <div sx={{ marginTop: "auto", width: "100%" }}>
        <Button
