...
export type PopupPersistedState<T> = [T, (value: T) => void, boolean];
function usePopupPersistedState<T extends valueType>(
  key: string,
  defaultValue: T
): PopupPersistedState<T> {
  ...
  const saveValue = useCallback(
    debounce((value: T) => saveData(key, value), 400),
    []
  );
