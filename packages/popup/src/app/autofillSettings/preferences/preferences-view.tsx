...
const I18N_KEYS = {
  ...
  BACK_TO_SETTINGS:
    "tab/autofill_settings/preferences/back_to_autofill_settings",
};
export interface PreferencesViewProps {
  handleClickBackToSettings: () => void;
}
export const PreferencesView = ({
  handleClickBackToSettings,
  ...
  return (
    <>
      <header className={styles.header} tabIndex={-1}>
        <button
          onClick={handleClickBackToSettings}
          className={styles.headerButton}
          aria-label={translate(I18N_KEYS.BACK_TO_SETTINGS)}
        >
