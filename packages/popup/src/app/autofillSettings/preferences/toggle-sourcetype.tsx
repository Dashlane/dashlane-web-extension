...
export const ToggleSourceType = ({
  ...
  const { addDisabledSourceTypes, removeDisabledSourceTypes } =
    useModuleCommands(autofillSettingsApi);
  const areSourceTypesEnabled = sourceTypes.some(
  ...
  return (
    <Toggle
      label={label}
      checked={areSourceTypesEnabled}
      onChange={toggleAutofillForSourceTypes}
      disabled={disabled}
      sx={{ fontSize: "14px" }}
      readOnly={readOnly}
    />
