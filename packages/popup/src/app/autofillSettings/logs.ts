...
export async function logAutofillToggledForUrl(
  domain: string,
...
const dataModelTypeToItemType: Partial<
  Record<AutofillableDataModel, ItemType>
> = {
...
export function logAutofillToggledForSourceTypes(
