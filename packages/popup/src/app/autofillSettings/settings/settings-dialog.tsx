...
const SettingsDialog = ({ visible, onConfirm, onCancel, }: SettingsDialogProps) => {
    const { translate } = useTranslate();
    return (<Dialog visible={visible} onConfirm={onConfirm} onCancel={onCancel} cancelLabel={translate(I18N_KEYS.CANCEL_ACTION)} confirmLabel={translate(I18N_KEYS.CONFIRM_ACTION)} autoFocusAction={'cancel'}>
      <>
