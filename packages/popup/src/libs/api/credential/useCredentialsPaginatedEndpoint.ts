...
import { CredentialFilterField, CredentialSearchOrder, CredentialsFirstTokenParams, CredentialSortField, FilterCriterium, SortCriterium, } from '@dashlane/communication';
...
export const useCredentialsPaginatedEndpoint = (searchValue: string, sortValue: CredentialSearchOrder) => {
