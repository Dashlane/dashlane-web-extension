...
export type ActionDetail = 'see_welcome' | 'click_login_welcome' | 'create_account_welcome' | 'resend_token' | 'invalid_token' | 'create_account' | 'switch_account' | 'another_account' | 'email_error' | 'token_success' | 'email_success';
...
export type Log = LoginLog | CredentialsLog | SecureNotesLog | DarkWebMonitoringNotificationLog | DetailLog | MoreToolsLog | ItemsLog | MenuLog | FooterLog | GeneratorLog | WebsiteLog | AutofillSettingsLog | GeneratedPasswordHistoryLog | WinbackOfferLog | PaymentFailureVaultLog | PaymentFailureRedDotLog | PostGraceVaultLog | MultipleDevicesLog | PremiumPromptLog;
