  ...
  return (
    <div className={styles.container}>
      <button
        ...
        data-testid="component-dropdown-title-popup"
        sx={{
          color: textColors,
          cursor: "pointer",
          display: "flex",
      ...
      >
        ...
        >
          <CaretDownIcon
            color={caretIconColors.color}
            activeColor={caretIconColors.activeColor}
            hoverColor={caretIconColors.activeColor}
          />
        </div>
      </button>
        ...
        >
          {items.map((item, idx) => (
            <Option
              ...
              isSecondaryOption={item.isSecondaryOption}
              isSelectedOption={title === item.label}
            />
          ))}
        </ul>
      ) : null}
