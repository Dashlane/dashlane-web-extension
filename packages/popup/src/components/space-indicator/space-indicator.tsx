...
export const SpaceIndicator = ({ spaceId, className }: SpaceIndicatorProps) => {
  ...
  return (
    <span title={spaceData.displayName}>
      <svg
        xmlns="__REDACTED__"
      ...
      >
        <g fill="none" fillRule="evenodd">
          <g fillRule="nonzero">
            <path
              id="a"
              fill={spaceData.color}
              fillRule="evenodd"
              d="M10.667 16H0V5.333L5.333 0H16v10.667z"
            />
            <path
              stroke="#FFF"
              strokeOpacity=".5"
          ...
          <text
            fill={defaultTheme.colors.ds.text.inverse.catchy}
            fontSize="10"
            fontWeight="bold"
          >
            <tspan
              ...
              y="12"
              textAnchor="middle"
              data-testid="space-indicator-letter"
            >
              {spaceData.letter}
            </tspan>
          </text>
