...
import { LOAD_ANONYMOUS_APPLICATION_ID, SAVE_CURRENT_LOCATION, SAVE_PLATFORM_INFO, } from 'Session/Store/platform/actions';
...
function setPlatformInfoWithDefaults(info: PlatformInfo, defaultInfo: PlatformInfo): PlatformInfo {
    return {
        anonymousApplicationId: info.anonymousApplicationId || defaultInfo.anonymousApplicationId,
        ...
        buildType: info.buildType ?? ApplicationBuildType.PRODUCTION,
    };
}
