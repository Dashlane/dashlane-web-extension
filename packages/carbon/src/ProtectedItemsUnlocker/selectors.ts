...
import { lastMasterPasswordCheckSelector, userLoginSelector, } from 'Session/selectors';
export const gracePeriodSelector = (state: State) => .test(userLoginSelector(state))
    ? 5000
    : 5 * 60 * 1000;
