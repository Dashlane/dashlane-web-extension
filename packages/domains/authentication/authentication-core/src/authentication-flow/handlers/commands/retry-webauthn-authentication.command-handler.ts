...
@CommandHandler(AuthenticationFlowContracts.RetryWebAuthnAuthenticationCommand)
export class RetryWebAuthnAuthenticationCommandHandler
  implements
    ICommandHandler<AuthenticationFlowContracts.RetryWebAuthnAuthenticationCommand>
{
