...
export class CheckSessionSessionNotCreated extends FunctionalError(
  CheckSessionKeyErrorTypes.SessionNotCreated,
...
export abstract class SessionKeyChecker {
  public abstract checkSessionKey(
    email: string,
    sessionKey: SessionKey
  ): Promise<Result<boolean, CheckSessionKeyErrors>>;
}
