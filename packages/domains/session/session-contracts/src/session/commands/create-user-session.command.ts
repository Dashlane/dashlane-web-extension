...
export class SessionAlreadyExists extends FunctionalError(SessionCreationErrorTypes.AlreadyExists, 'The session already exists. Delete it first.') {
}
export type CreateSessionErrors = SessionAlreadyExists;
export class CreateUserSessionCommand extends defineCommand<SessionCreationParams, CommandSuccess, CreateSessionErrors>({
