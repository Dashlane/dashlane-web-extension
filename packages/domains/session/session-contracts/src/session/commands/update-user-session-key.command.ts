...
export class UnableToUpdateSessionKeyForNonExistingAccount extends FunctionalError(
  ChangeSessionKeyErrorTypes.NotCreated,
  "The session has not been created. Create it first."
) {}
export class UnableToUpdateSessionSessionNotOpened extends FunctionalError(
  ChangeSessionKeyErrorTypes.NotOpened,
  "The session has not been opened"
) {}
export type UpdateUserSessionKeyErrors =
  | UnableToUpdateSessionKeyForNonExistingAccount
  | UnableToUpdateSessionSessionNotOpened;
export class UpdateUserSessionKeyCommand extends defineCommand<
