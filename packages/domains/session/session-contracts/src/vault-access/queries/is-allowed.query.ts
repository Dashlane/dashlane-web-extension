...
export enum NotAllowedReason {
  ...
  RequiresChangeLoginEmail = "RequiresChangeLoginEmail",
...
export class UserNotLogged extends FunctionalError(
  "UserNotLogged",
  "Please log the user"
) {}
export type IsAllowedQueryFailure = UserNotLogged;
export class IsAllowedQuery extends defineQuery<
  IsAllowedQueryResult,
  IsAllowedQueryFailure
>({
