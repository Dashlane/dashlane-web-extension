...
import { sessionApi, SessionKeyChecker } from '@dashlane/session-contracts';
...
import { SessionStateQueryHandler } from './handlers/queries/session-state.query.handler';
import { CreatedSessionsStateQueryHandler } from './handlers/queries/created-sessions-state.query.handler';
    ...
    handlers: {
        ...
        events: {
            ...useEventsOfModule(carbonLegacyApi, {
                ...
                CarbonLegacyDeviceRemotelyDeleted: CarbonLegacyDeviceRemotelyDeletedEventHandler,
            }),
        },
        queries: {
            createdSessionsState: CreatedSessionsStateQueryHandler,
            sessionState: SessionStateQueryHandler,
