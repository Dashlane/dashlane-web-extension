...
export class SessionKeyEncryptor {
    ...
    public encrypt(clearContents: ArrayBuffer, sessionKey: SessionKey, settings: CryptoSettings): Promise<ArrayBuffer> {
        ...
        return flexibleEncryptor.encrypt(encryptionKey, clearContents, derivation, DEFAULT_CBCHMAC_CIPHER_CONFIG, {
