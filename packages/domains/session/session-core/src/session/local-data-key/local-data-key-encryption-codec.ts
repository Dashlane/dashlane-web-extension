...
@Injectable()
export class LocalDataKeyEncryptionCodec
  implements DefaultEncryptionCodecForUserData
{
  public constructor(
    private localDataKeyDecryptor: LocalDataKeyDecryptor,
    private localDatKeyaEncryptor: LocalDataKeyEncryptor
  ) {}
