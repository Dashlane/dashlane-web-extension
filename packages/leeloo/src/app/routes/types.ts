...
export interface NamedRoutes {
    ...
    teamSettingsSsoEncryption: string;
    ...
    teamGetStartedRoutePath: string;
    ...
    userAddWebsiteCredentialWithPrefilledParameters: (routeState: AddWebsiteRouteState) => LocationDescriptor;
    ...
    userVaultItem: (vaultItemUuid: string, vaultItemType: VaultItemType, pathname: string) => string;
