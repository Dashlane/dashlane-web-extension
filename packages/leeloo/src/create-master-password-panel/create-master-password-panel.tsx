...
import { PasswordStrengthTooltip } from "../account-creation/account-creation-form/password-strength-tooltip/password-strength-tooltip";
...
import { PasswordTipsDialog } from "./password-tips-dialog/password-tips-dialog";
...
const I18N_KEYS = {
  ...
  CONFIRM_PASSWORD_FLOATING_LABEL:
    "webapp_sso_to_mp_confirm_password_floating_label",
  ...
  CREATE_PASSWORD_FLOATING_LABEL:
    "webapp_sso_to_mp_create_password_floating_label",
...
export const CreateMasterPasswordPanel = ({
  dispatchGlobal,
  onSubmit,
  createMPForAccountRecovery,
  ...
  const [createPasswordErrorType, setCreatePasswordErrorType] =
    React.useState<ErrorTypes.WEAK_PASSWORD_ERROR | null>(null);
  const [isCreatePasswordFocused, setIsCreatePasswordFocused] =
    React.useState(true);
  const [confirmPasswordValue, setConfirmPasswordValue] = React.useState("");
  const [confirmPasswordErrorType, setConfirmPasswordErrorType] =
    React.useState<ErrorTypes.PASSWORDS_DONT_MATCH_ERROR | null>(null);
  const {
    passwordStrength,
  ...
  const getPasswordErrorText = (
    passwordErrorType: ErrorTypes | null,
  ...
  const handleConfirmFormSubmitted = async (
  ...
  const handleCreatePasswordBlurred = () => {
    ...
    const shouldDisplayMismatchingPasswordsError =
      createPasswordValue &&
    ...
    setConfirmPasswordErrorType(
      shouldDisplayMismatchingPasswordsError
  ...
  return (
    <div className={styles.createPasswordPanelContainer}>
      <PasswordTipsDialog
      ...
      <div className={styles.content}>
        ...
        <div className={styles.inner}>
          ...
          <form
            ...
            autoComplete="off"
            noValidate={true}
            onSubmit={handleConfirmFormSubmitted}
          >
            <div className={styles.createPasswordContainer}>
              <PasswordStrengthTooltip
                id="password-tooltip"
                passwordStrength={passwordStrength}
                showTooltip={isCreatePasswordFocused}
              >
                <PasswordInput
                  showPasswordTooltipText={translate(
                    I18N_KEYS.CREATE_PASSWORD_SHOW_LABEL
                  )}
                  hidePasswordTooltipText={translate(
                    I18N_KEYS.CREATE_PASSWORD_HIDE_LABEL
                  )}
                  onBlur={handleCreatePasswordBlurred}
                  onFocus={handleCreatePasswordFocused}
                  onChange={handleCreatePasswordChanged}
                  placeholder={translate(I18N_KEYS.CREATE_PASSWORD_HINT_TEXT)}
                  value={createPasswordValue}
                  label={translate(I18N_KEYS.CREATE_PASSWORD_FLOATING_LABEL)}
                  feedbackType={createPasswordErrorType ? "error" : undefined}
                  feedbackText={
                ...
                isPasswordStrengthScore(passwordStrength.score) && (
                  <PasswordStrength
                    ...
                    additionalText={translate(
                      `account_creation_${
                        ZXCVBN_SCORE_TRANSLATION_MAPPING[passwordStrength.score]
                      }`
                    )}
                  />
                )}
            ...
            <PasswordInput
              ...
              showPasswordTooltipText={translate(
                I18N_KEYS.CONFIRM_PASSWORD_SHOW_LABEL
              )}
              hidePasswordTooltipText={translate(
                I18N_KEYS.CONFIRM_PASSWORD_HIDE_LABEL
              )}
              placeholder={translate(I18N_KEYS.CONFIRM_PASSWORD_HINT_TEXT)}
              onBlur={handleConfirmPasswordBlurred}
              onChange={handleConfirmPasswordChanged}
              label={translate(I18N_KEYS.CONFIRM_PASSWORD_FLOATING_LABEL)}
              feedbackType={confirmPasswordErrorType ? "error" : undefined}
              feedbackText={
            ...
            <Flex className={styles.formAction}>
              {createMPForAccountRecovery ? (
                <RouterLink
                  className={styles.previousStepContainer}
                  to={routes.userDeviceRegistration}
                  replace
                >
                  <BackIcon size={14} />
              ...
              >
                {isLoading ? (
                  ...
                  translate(I18N_KEYS.CREATE_PASSWORD_BUTTON)
                )}
              </Button>
            </Flex>
            {showCreateMasterPasswordError &&
