...
export const loginAndUkiLoaded = reducer.registerAction('USER_LOGGED_IN_WITH_UKI', (state: State, { login, uki }: {
    login: string;
    uki: string;
}) => Object.assign({}, state, {
...
export const permissionsLoaded = reducer.registerAction('USER_PERMISSIONS_LOADED', (state: State, { permissions }: {
...
export const userLoggedOut = reducer.registerAction<void>('USER_LOGGED_OUT', (state: State) => Object.assign({}, state, getEmptyState()));
