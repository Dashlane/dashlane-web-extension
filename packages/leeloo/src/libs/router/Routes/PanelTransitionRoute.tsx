...
export const Route = (props: CustomRouteProps): JSX.Element => {
  ...
  return (
    <CommonRoute {...otherRouteProps} stayMounted>
      {(routerProps: CustomRouteComponentProps) => {
        ...
        return createPortal(
          <>
            ...
            <div
              className={classnames(cssPanel.parentSlider, {
            ...
            >
              <TransitionGroup>
                {isOpen && (
                  <CSSTransition
                    key={routerProps.location.pathname}
                    classNames={cssTransitions}
                    timeout={PanelTransitionTimeout}
                  >
                    {Component ? (
                      <Component {...routerProps} {...additionalProps} />
                    ) : (
                      <div {...routerProps} {...additionalProps} />
                    )}
                  </CSSTransition>
                )}
              </TransitionGroup>
