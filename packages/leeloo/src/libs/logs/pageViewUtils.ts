...
export const logCurrentRoutePageView = (pathname: string, routes: NamedRoutes) => {
    ...
    const matchingRoute = Object.keys(routeToPageView).find((route) => pathname.startsWith(route));
    if (matchingRoute) {
