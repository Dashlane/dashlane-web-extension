import { AccountCreationStatus, UserCreateAccountEvent, WebAccountCreation, } from '@dashlane/hermes';
...
export const logUserWebAccountCreationEvent = (cookieData: UserFunnelCookie, emailsTipsAndOffersValue: boolean) => {
    ...
    logEvent(new UserCreateAccountEvent({
