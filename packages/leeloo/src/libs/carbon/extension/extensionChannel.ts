...
class WebExtensionChannel extends GenericChannel {
    ...
    private setup(): void {
        ...
        this._port.onMessage.addListener((msg: TransportMessage) => this._messageReceived(msg));
...
function getChannelForCurrentEnvironment(): WebExtensionChannel | null {
    if (CARBON_EMBEDDED) {
        return null;
    }
...
const LeelooWebExtChannel: Channel | null = getChannelForCurrentEnvironment();
