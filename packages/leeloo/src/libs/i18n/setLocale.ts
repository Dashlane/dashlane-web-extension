...
export function setLocale(counterpart: Counterpart, locale: string, data: {
    [k: string]: string;
}) {
    const defaultTranslations = {
        counterpart: { pluralize: require('pluralizers/en') },
    };
    counterpart.registerTranslations(locale, Object.assign<any, CounterpartModule._Translations>(defaultTranslations, transformLangStrings(data)));
