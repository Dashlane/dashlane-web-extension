...
import { isPasswordStrengthScore, ZXCVBN_MULTIPLYING_FACTOR, ZXCVBNToPasswordStrengthScore, } from 'libs/password-evaluation/helpers';
...
const checkIsPasswordStrongEnough = (passwordStrength: PasswordStrength | null) => {
    if (!passwordStrength) {
        return false;
    }
