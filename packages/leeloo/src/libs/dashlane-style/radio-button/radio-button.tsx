...
export const RadioButton = ({ children, className, key, disabled, labelClassName, ...inputProps }: RadioButtonProps) => {
    return (<label key={key} className={classnames({
            [styles.disabled]: disabled,
        }, styles.radioWrapper, className)}>
