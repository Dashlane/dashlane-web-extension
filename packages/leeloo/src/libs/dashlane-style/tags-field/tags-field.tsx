...
export const TagsField = (props: TagsFieldProps) => {
  ...
  const shouldRemove = (event: InputRefKeyboardEvent) =>
    REMOVE_TAG_KEYS.has(event.keyCode) &&
    props.tags.length > 0 &&
    getInputValue().trim() === "";
  ...
  const onPaste = (event: ClipboardEvent) => {
    ...
    const tags = props.formatToTags(event.clipboardData.getData("Text"));
