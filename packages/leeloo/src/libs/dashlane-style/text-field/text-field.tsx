...
import styles from 'libs/dashlane-style/text-field/style.css';
...
export class TextField extends React.Component<Props, TextFieldState> {
    ...
    protected handleFieldChange(event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) {
        const { target } = event;
    ...
    public render() {
        ...
        const containerClasses = classnames(styles.container, containerClassesDynamic);
        const label = this.props.labelText ? (<div className={styles.label} style={this.props.labelStyle}>
        ...
        const fieldProps = {
            ...
            ref: (element: HTMLInputElement | HTMLTextAreaElement | null) => (this._field = element),
            ...fieldOtherProps,
        };
        ...
        const hint = this.props.keepHintArea ||
            (!this.props.value && this.props.hintText) ||
            this.props.successText ||
            this.props.errorText ? (<div className={styles.hint} style={this.props.hintStyle}>
          {this.props.errorText ||
                this.props.successText ||
                this.props.hintText}
        </div>) : null;
        return (<div className={containerClasses} style={this.props.containerStyle}>
        {label}
        <div className={decoratorClasses}>
          {this.props.multiLine ? (<textarea style={inputStyle} {...fieldProps}/>) : (<input style={inputStyle} {...fieldProps}/>)}
