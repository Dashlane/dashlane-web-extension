...
import { useFrozenState } from "../../../frozen-state/frozen-state-dialog-context";
...
export const ButtonWithPopup = forwardRef<
  ButtonWithPopupRef,
  PropsWithChildren<ButtonWithPopupProps>
>(
  (
    {
      buttonLabel,
      ...
      popupClassName,
      buttonMood = "brand",
      buttonIntensity = "catchy",
      buttonIconName = "ActionAddOutlined",
      children,
    },
      ...
      <div style={{ position: "relative" }}>
        ...
        {showPopup && (
          <Popup
            ...
            onClickOutside={handleCancelAction}
          >
