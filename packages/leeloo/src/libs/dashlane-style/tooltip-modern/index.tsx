...
export default class TooltipModern extends React.Component<Props, State> {
    ...
    public render() {
        const { iconClassNames = [], maxWidth = DEFAULT_MAX_WIDTH, children, } = this.props;
        const icon = this.renderIcon();
        return (<div className={styles.container} onMouseEnter={this.showTooltip} onMouseLeave={this.hideTooltip}>
