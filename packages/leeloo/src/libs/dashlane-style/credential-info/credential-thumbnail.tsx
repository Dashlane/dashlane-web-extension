...
export const CredentialThumbnail = ({
  ...
  const foundType = getIconSourceSizeKey(size).find(
    (type) => type in (domainIcon?.urls ?? {})
  );
  ...
  return (
    <Thumbnail
      ...
      icon={nativeIcon}
      iconColor={colors.lightTheme.ds.text.brand.standard}
