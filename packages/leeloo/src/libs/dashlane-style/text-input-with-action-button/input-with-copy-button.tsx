import { CopyIcon, jsx, PasswordInput, PropsOf, TextInput, Tooltip, } from '@dashlane/ui-components';
...
export const InputWithCopyButton = ({ inputValue, textInputProps, tooltipProps, passwordInputProps, iconButtonProps, }: InputWithCopyButtonProps) => {
    ...
    const passwordActionProps = passwordInputProps
        ...
        : undefined;
    return (<InputWithActionButton passwordInputProps={passwordActionProps} textInputProps={{
            ...textInputProps,
            value: inputValue,
        }} iconButtonProps={{
            icon: <CopyIcon />,
