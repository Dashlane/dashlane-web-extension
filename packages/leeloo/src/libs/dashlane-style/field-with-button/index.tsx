...
import { Button, ButtonIconLayout } from "@dashlane/design-system";
...
const getButtonIconLayout = (
  fieldState: FieldState,
  propsLayout: ButtonIconLayout | undefined,
  propsIcon: JSX.Element | undefined
): {
  layout: ButtonIconLayout;
...
export const FieldWithButton = ({
  ...
  return (
    <form ref={form} onSubmit={handleSubmit} className={styles.container}>
      <div className={textFieldClassName || styles.textFieldColumn}>
        <TextField
          aria-labelledby={ariaLabelledBy}
          multiLine={multiLine}
          isDisabled={isFieldButtonDisabled}
          ...
          hintText={hintState === HintState.Default ? hintText : null}
          successText={hintState === HintState.Success ? hintText : null}
          errorText={hintState === HintState.Error ? hintText : null}
          onBlur={handleSubmit}
          ...
          inputClassName={classNames(styles.inputField, inputFieldClassName)}
          value={value}
        />
      </div>
      <div className={buttonClassName}>
        <Button
          mood="neutral"
          intensity="quiet"
          layout={getButtonIconLayout(fieldState, layout, icon).layout}
          icon={getButtonIconLayout(fieldState, layout, icon).icon}
          disabled={isFieldButtonDisabled}
          onClick={() => field.current && field.current.focus()}
        >
          {getLabel()}
        </Button>
      </div>
