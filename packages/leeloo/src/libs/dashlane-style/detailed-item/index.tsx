...
export const DetailedItem = (content: DetailedItemParams) => {
    ...
    return (<div className={detailedItemClassName}>
      <div className={styles.detailedItemDetails}>
        ...
        <div className={styles.itemDetails}>
          <div className={styles.itemTitle}>
            ...
            {titleLogo && (<div className={styles.itemTitleLogo}>{titleLogo}</div>)}
          </div>
          {text && (<div sx={{
      ...
      {infoAction && (<div className={styles.detailedItemInfoAction}>{infoAction}</div>)}
    </div>);
};
