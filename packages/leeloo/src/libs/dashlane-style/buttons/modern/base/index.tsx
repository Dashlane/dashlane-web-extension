...
const StandardButton = ({
  ...
  const iconComponent = (
    <span
      className={classnames(styles.iconContainer, iconClassName)}
  ...
  const content = (
    <span
      className={classnames(styles.labelContainer, labelClassName)}
      {...onDropdownAttributes}
    >
      {loading ? (
        <span className={classnames(styles.loading, spinnerClassName)} />
      ) : null}
      <span
        className={classnames(styles.buttonContents, {
