...
interface DisabledButtonWithTooltipProps
  extends PropsOf<typeof Button>,
    Pick<PropsOf<typeof Tooltip>, "placement" | "content"> {
  loading?: boolean;
  key?: Key | undefined;
...
export const DisabledButtonWithTooltip = ({
  ...
  <Tooltip
    content={content}
    passThrough={!buttonProps.disabled || loading || neverShowTooltip}
    placement={placement}
    sx={tooltipSx ? tooltipSx : {}}
  >
    <span
      sx={{
    ...
    >
      <Button
        ...
        mood={mood}
        intensity={intensity}
        sx={buttonProps.disabled ? { pointerEvents: "none" } : {}}
        isLoading={loading}
