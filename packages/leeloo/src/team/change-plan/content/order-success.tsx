...
import { Button, ButtonIntensity, colors, Flex } from "@dashlane/design-system";
  ...
  const data = {
    team: {
      ...
      features: [
        {
          header:
            "team_account_teamplan_changeplan_success_features_vpn_header",
          description:
            "team_account_teamplan_changeplan_success_features_vpn_description",
          ...
          actions: [
            {
              ...
              intensity: "catchy",
              content:
                "team_account_teamplan_changeplan_success_features_actions_turn_on_vpn_access",
              link: PATHS.POLICIES,
            },
            {
              external: true,
              ...
              intensity: "quiet",
              content:
                "team_account_teamplan_changeplan_success_features_actions_see_setup_guide",
              link: "__REDACTED__",
            },
          ],
        },
        {
          header:
            "team_account_teamplan_changeplan_success_features_protection_header",
          description:
            "team_account_teamplan_changeplan_success_features_protection_description",
    ...
    business: {
      ...
      description:
        "team_account_teamplan_changeplan_success_business_description",
      ...
      features: [
          ...
          actions: [
            {
              ...
              intensity: "catchy",
              content:
                "team_account_teamplan_changeplan_success_features_actions_start_setup",
              link: PATHS.SSO,
            },
            {
              external: true,
        ...
        {
          header:
            "team_account_teamplan_changeplan_success_features_scim_header",
          description:
            "team_account_teamplan_changeplan_success_features_scim_description",
        ...
        {
          header:
            "team_account_teamplan_changeplan_success_features_friends_and_family_header",
          description:
            "team_account_teamplan_changeplan_success_features_friends_and_family_description",
          icon: <SharingGroupIcon size={24} />,
          actions: [
            {
              external: true,
              ...
              intensity: "catchy",
              content:
                "team_account_teamplan_changeplan_success_features_actions_learn_more",
              link: "__REDACTED__",
            },
          ],
        },
        {
          header:
            "team_account_teamplan_changeplan_success_features_phone_support_header",
          description:
            "team_account_teamplan_changeplan_success_features_phone_support_description",
          ...
          actions: [
            {
              ...
              intensity: "catchy",
              content:
                "team_account_teamplan_changeplan_success_features_actions_schedule_a_call",
              link: "__REDACTED__",
...
export const OrderSuccess = ({ targetPlan }: Props) => {
  ...
  return (
    <>
      ...
      <ChangePlanCard
        title={translate(data.header)}
        sx={{ width: "632px", padding: "32px", borderRadius: "8px" }}
      >
        <div style={{ marginTop: "8px" }}>
          <Paragraph
            size="medium"
            color={colors.lightTheme.ds.text.neutral.quiet}
          >
              ...
              <Flex gap="16px" flexWrap="nowrap">
                <div
                  style={{
                    ...
                    borderRadius: "8px",
                    backgroundColor:
                      colors.lightTheme.ds.container.expressive.brand.quiet
                        .idle,
                  }}
                >
                  {feature.icon}
                  ...
                  <Flex gap="8px">
                    {feature.actions.map((action) =>
                      action.external ? (
                        ...
                        <Link to={action.link} key={action.content}>
                          <Button
                            mood={action.mood}
                            intensity={action.intensity as ButtonIntensity}
                            size="small"
                            type="button"
                          >
                            {translate(action.content)}
