...
export const isExpired = (billingInformation: BillingInformation) => {
...
export const hasCreditCardPaymentMethod = (billingInformation: BillingInformation) => {
    return billingInformation && !!billingInformation.last4;
};
