...
export const PurchaseDialog = ({
  ...
  return (
    <Dialog
      ...
      closeIconName={translate("_common_dialog_dismiss_button")}
      onClose={() => {
        logEvent(
    ...
    >
      <DialogTitle
        title={translate("team_dashboard_purchase_dialog_title", {
          plan: planCopy,
        })}
      />
      <DialogBody>
        ...
        <div sx={{ marginTop: "24px" }}>
          <Infobox
            size="large"
            mood="warning"
            title={translate("team_dashboard_purchase_dialog_infobox_copy_1")}
            description={translate(
              "team_dashboard_purchase_dialog_infobox_copy_2"
            )}
          />
        </div>
      </DialogBody>
