...
export const checkDirectorySyncKeyRequestAction =
  reducer.registerAction<CheckDirectorySyncKeyRequest>(
    "CHECK_DIRECTORY_SYNC_KEY_REQUEST",
    (state, request) => {
      if (!request) {
        return state;
      }
...
export const keyValidationPostponedAction = reducer.registerAction<void>(
  "KEY_VALIDATION_POSTPONED",
  pipe(hideDialog, setValidationPostponed)
);
export const reopenDialogAction = reducer.registerAction<void>(
  "REOPEN_DIALOG",
  pipe(showDialog, resetValidationPostponed)
);
export const closeNotificationAction = reducer.registerAction<void>(
  "CLOSE_NOTIFICATION",
  resetValidationPostponed
);
export const keyValidatedAction = reducer.registerAction<void>(
  "KEY_VALIDATED",
  pipe(hideDialog, resetValidationPostponed, resetRequest)
);
export const keyRejectedAction = reducer.registerAction<void>(
  "KEY_REJECTED",
  pipe(hideDialog, resetValidationPostponed, resetRequest)
);
export const hideDialogAction = reducer.registerAction<void>(
  "HIDE_DIALOG",
  hideDialog
);
export const terminateRequestAction = reducer.registerAction<void>(
  "TERMINATE_REQUEST",
  pipe(resetValidationPostponed, resetRequest)
);
