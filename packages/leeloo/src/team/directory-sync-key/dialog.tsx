...
const I18N_KEYS = {
  ...
  INITIAL_MESSAGE_MARKUP:
    "team_directory_sync_key_dialog_initial_message_markup",
  ...
  KEY_SUSPENDED_MESSAGE_MARKUP:
    "team_directory_sync_key_dialog_key_suspended_message_markup",
};
export const DirectorySyncKeyDialog = (props: Props) => {
  const { translate } = useTranslate();
  const [uiStep, setUIStep] = useState<Step>(Step.Initial);
  const checkDirectorySyncKeyRequest = () =>
    props.lee.globalState.directorySyncKey.checkDirectorySyncKeyRequest;
  const rejectKey = () => {
  ...
  const renderInitialStep = () => {
    return (
      <StepDialogWithTitle
        onRequestClose={postponeValidation}
        footer={
          <DialogFooter
            primaryButtonTitle={translate(I18N_KEYS.INITIAL_CONTINUE)}
            primaryButtonOnClick={goToKeyInputStep}
            secondaryButtonTitle={translate(I18N_KEYS.INITIAL_POSTPONE)}
            secondaryButtonOnClick={postponeValidation}
            intent="primary"
          />
        }
      >
  ...
  const renderKeyInputStep = () => {
    return (
      <KeyInputStep
        onSubmitKeySuccess={onSubmitKeySuccess}
        onSubmitKeyError={onSubmitKeyError}
        checkDirectorySyncKeyRequest={checkDirectorySyncKeyRequest}
        handleDismiss={postponeValidation}
  ...
  const renderKeySuccessStep = () => {
    return (
      <StepDialogWithTitle
        ...
        footer={
          <DialogFooter
            secondaryButtonTitle={translate(I18N_KEYS.KEY_SUCCESS_CLOSE)}
            secondaryButtonOnClick={hideDialog}
          />
        }
      >
        <Flex gap="8px">
  ...
  const renderKeyErrorStep = () => {
    return (
      <StepDialogWithTitle
        ...
        footer={
          <DialogFooter
            primaryButtonTitle={translate(I18N_KEYS.KEY_ERROR_VALIDATE)}
            primaryButtonOnClick={handleConfirmPastedLatestKey}
            secondaryButtonTitle={translate(I18N_KEYS.KEY_ERROR_RETRY)}
            secondaryButtonOnClick={goToKeyInputStep}
            intent="danger"
          />
        }
      >
  ...
  const renderKeySuspendedStep = () => {
    return (
      <StepDialogWithTitle
        ...
        footer={
          <DialogFooter
            secondaryButtonTitle={translate(I18N_KEYS.KEY_SUSPENDED_CLOSE)}
            secondaryButtonOnClick={hideDialog}
          />
        }
      >
