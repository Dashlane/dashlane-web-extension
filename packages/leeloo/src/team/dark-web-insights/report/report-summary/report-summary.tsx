  ...
  return (
    <Card sx={{ marginBottom: "24px" }}>
      ...
      <GridContainer
        ...
        gridTemplateAreas='"label-0 divider-left label-1 divider-right label-2 invite-all" "title-0 divider-left title-1 divider-right title-2 invite-all"'
        alignItems="center"
        sx={{
          columnGap: "16px",
      ...
      >
        <ReportSummaryInfo
          ...
          label={translate(I18N_KEYS.EMPLOYEES_AFFECTED)}
          titleGridArea="title-0"
          title={reports.emailsImpactedCount}
        />
        <ReportSummaryDivider gridArea="divider-left" />
        <ReportSummaryInfo
          labelGridArea="label-1"
          label={translate(I18N_KEYS.TOTAL_INCIDENTS)}
          titleGridArea="title-1"
          title={reports.leaksCount}
        />
        <ReportSummaryDivider gridArea="divider-right" />
        <ReportSummaryInfo
          labelGridArea="label-2"
          label={translate(I18N_KEYS.NOT_PROTECTED)}
          titleGridArea="title-2"
          title={translate(I18N_KEYS.EMPLOYEE_INVITATION, {
