...
import {
  LEARN_DARK_WEB_INSIGHTS_LINK,
  VIEW_DOMAIN_VERIFICATION_GUIDE_LINK,
} from "../dark_web_insights_urls";
import {
  HelpCenterArticleCta,
  UserOpenHelpCenterEvent,
} from "@dashlane/hermes";
import { InfoCard } from "../../settings/components/layout/info-card";
import { logEvent } from "../../../libs/logs/logEvent";
import { ExternalLink } from "../../settings/components/layout/link-card";
const I18N_KEYS = {
  ...
  LEARN_DOMAIN_VERIFICATION_TXT:
    "team_breach_report_learn_domain_verification_txt",
};
  ...
  return (
    <div>
      <InfoCard>
        ...
        <ExternalLink
          href={LEARN_DARK_WEB_INSIGHTS_LINK}
          onClick={() => {
            logEvent(
              new UserOpenHelpCenterEvent({
                helpCenterArticleCta:
                  HelpCenterArticleCta.LearnAboutDarkWebInsights,
              })
            );
          }}
        >
        ...
        <ExternalLink
          ...
          onClick={() => {
            logEvent(
              new UserOpenHelpCenterEvent({
                helpCenterArticleCta:
                  HelpCenterArticleCta.LearnAboutDomainVerification,
              })
            );
          }}
        >
