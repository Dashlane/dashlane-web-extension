...
export const AlertQueue = () => {
    ...
    return (<SimpleDialog isOpen onRequestClose={handleDismiss} footer={<DialogFooter secondaryButtonTitle={displayAlert.okButtonLabel ??
                translate(I18N_KEYS.ALERT_DISMISS_BUTTON)} secondaryButtonOnClick={handleDismiss}/>} title={displayAlert.title}>
