...
export const InviteLinkSharingDialog = ({
  showSharingDialog,
  setShowSharingDialog,
}: InviteLinkSharingDialogProps) => {
  ...
  const handleCopyClick = () => {
    ...
    alert.showAlert(
      translate(I18N_KEYS.COPY_SUCCESS_TOAST),
    ...
    >
      ...
      <DialogFooter>
        <CopyButton
          ...
          buttonText={translate(I18N_KEYS.COPY_BUTTON)}
