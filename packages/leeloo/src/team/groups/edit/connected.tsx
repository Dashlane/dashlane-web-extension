...
import { EditGroup, EditGroupProps } from "./edit-group";
...
const userGroupSelector: Selector<
  UserGroupDownload | null | undefined,
  WrapperProps,
  string
> = {
...
export const Connected = connect(
  remoteDataAdapter<InjectedProps, EditGroupProps>(EditGroup, remoteDataConfig),
  selectors
);
