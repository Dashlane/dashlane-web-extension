...
const I18N_KEYS = {
  REVOKE_MEMBER_FROM_GROUP_ERROR_TITLE:
    "team_groups_edit_revoke_member_from_group_error_title",
  REVOKE_MEMBER_FROM_GROUP_ERROR_MESSAGE:
    "team_groups_edit_revoke_member_from_group_error_message",
  MEMBER_LIST_HEADER_EMAIL: "team_groups_edit_member_list_header_email",
  MEMBER_LIST_HEADER_GROUP_RIGHTS:
    "team_groups_edit_member_list_header_group_rights",
  MEMBER_LIST_ACTION_REMOVE_DIALOG_CTA:
    "team_groups_edit_member_list_action_remove_dialog_cta",
  MEMBER_LIST_ACTION_REMOVE_DIALOG_CANCEL:
    "team_groups_edit_member_list_action_remove_dialog_cancel",
  MEMBER_LIST_ACTION_REMOVE_DIALOG_HEADER:
    "team_groups_edit_member_list_action_remove_dialog_header",
  MEMBER_LIST_ACTION_REMOVE_DIALOG_TITLE:
    "team_groups_edit_member_list_action_remove_dialog_title",
  MEMBER_LIST_ACTION_REMOVE_DIALOG_SUBTITLE:
    "team_groups_edit_member_list_action_remove_dialog_subtitle",
};
interface Props {
  lee: Lee;
  className?: string;
...
const MemberList = ({ lee, className, userGroup, revokeMembers }: Props) => {
      ...
      just: ({
        ...
        revokeMembers(
          ...
          },
          {
            ...
            message: translate(
              I18N_KEYS.REVOKE_MEMBER_FROM_GROUP_ERROR_MESSAGE
            ),
          }
        );
      },
  ...
  const getActiveMembers = (): UserDownload[] =>
  ...
  const mapMemberToRow = (m: UserDownload) => (
    <MemberRow
      key={m.alias}
      member={m}
    ...
    <div>
      ...
      <div className={styles.pagination}>
        <Pagination
          ...
          itemsLength={getActiveMembers().length}
          itemsPerPage={ROWS_PER_PAGE}
          onChange={onChangePage}
        />
      </div>
      <SimpleDialog
        isOpen={removeDialogState.showRemoveUserDialog}
        onRequestClose={handleRemoveMemberCancelled}
        footer={
          <DialogFooter
            primaryButtonTitle={translate(
              I18N_KEYS.MEMBER_LIST_ACTION_REMOVE_DIALOG_CTA
            )}
            primaryButtonOnClick={handleRemoveMemberConfirmed}
            secondaryButtonTitle={translate(
              I18N_KEYS.MEMBER_LIST_ACTION_REMOVE_DIALOG_CANCEL
            )}
            secondaryButtonOnClick={handleRemoveMemberCancelled}
          />
        }
