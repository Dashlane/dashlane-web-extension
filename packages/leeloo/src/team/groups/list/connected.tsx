...
import { Lee } from 'lee';
import { GroupList } from 'team/groups/list/group-list';
...
export const Connected = connect(remoteDataAdapter<InjectedProps, Props>(GroupList, remoteDataConfig), selectors);
