...
import { Button, Dialog, Heading, jsx, Paragraph, } from '@dashlane/design-system';
...
const I18N_KEYS = {
    ...
    DIALOG_PRIMARY_ACTION: 'tac_settings_confidential_scim_regenerate_token_dialog_primary_action',
    DIALOG_SECONDARY_ACTION: 'tac_settings_confidential_scim_regenerate_token_dialog_secondary_action',
};
...
export const GenerateToken = ({ isTokenGenerated }: GenerateTokenProps) => {
    ...
    return (<>
      ...
      <Button intensity={isTokenGenerated ? 'quiet' : 'catchy'} mood="brand" isLoading={!isTokenGenerated && isGenerating} onClick={isTokenGenerated
            ? () => setConfirmationDialogOpen(true)
            : generateToken}>
        {translate(isTokenGenerated
      ...
      <Dialog actions={{
        ...
        }} closeActionLabel="Close" onClose={() => setConfirmationDialogOpen(false)} title={translate(I18N_KEYS.DIALOG_TITLE)} isOpen={isConfirmationDialogOpen}>
