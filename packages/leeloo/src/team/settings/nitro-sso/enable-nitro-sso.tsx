...
const I18N_KEYS = {
  ...
  CONFIRM_DIALOG_TITLE:
    "sso_confidential_enable_nitro_sso_confirm_dialog_title",
  CONFIRM_DIALOG_BODY: "sso_confidential_enable_nitro_sso_confirm_dialog_body",
  CONFIRM_DIALOG_PRIMARY_ACTION_LABEL:
    "sso_confidential_enable_nitro_sso_confirm_dialog_primary_action_label",
    ...
    <>
      ...
      >
        ...
        <div sx={{ justifySelf: "end" }}>
          <Button
            id={FIELDS.ENABLE_TOGGLE}
            onClick={enableSSOClicked}
            disabled={interactionImpossible}
          >
