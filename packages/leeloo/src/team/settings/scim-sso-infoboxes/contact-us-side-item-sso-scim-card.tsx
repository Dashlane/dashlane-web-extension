...
export const ContactUsSideContent = ({
  openContactDialog,
}: {
  ...
  return (
    <LinkCard
      supportHeading={translate(I18N_KEYS.CONTACT_SUPPORT_HEADER)}
      heading={translate(I18N_KEYS.CONTACT_HEADING)}
      description={translate(I18N_KEYS.CONTACT_DESCRIPTION)}
      linkText={translate(I18N_KEYS.CONTACT_LINK_TITLE)}
      linkProps={{
