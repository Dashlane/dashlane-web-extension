...
type SelfHostedSSOSteps =
  | SsoSetupStep.SetUpEncryptionServiceSettings
  | SsoSetupStep.SelectEncryptionServicePlatform
  | SsoSetupStep.GenerateAndSaveConfiguration
  | SsoSetupStep.AddConfigurationToServiceHost
  | SsoSetupStep.TurnOnSso
  | SsoSetupStep.CompleteSsoSetup
  | SsoSetupStep.ChooseYourSsoSolution
  | SsoSetupStep.ClearSsoSettings
  | SsoSetupStep.ReturnToSsoSelection;
type LogSelfHostedSSOSetupParams = Omit<
  LogSSOSetupParams,
...
type NitroSSOSteps =
  | SsoSetupStep.CreateSsoApplication
  | SsoSetupStep.ValidateIdpMetadata
  | SsoSetupStep.UpdateIdpSettings
  | SsoSetupStep.SubmitEmailDomain
  | SsoSetupStep.EmailDomainError
  | SsoSetupStep.VerifyDomain
  | SsoSetupStep.TestSsoConnection
  | SsoSetupStep.TurnOnSso
  | SsoSetupStep.CompleteSsoSetup
  | SsoSetupStep.ChooseYourSsoSolution
  | SsoSetupStep.ClearSsoSettings
  | SsoSetupStep.ReturnToSsoSelection;
type LogNitroSSOSetupParams = Omit<
  LogSSOSetupParams,
  | "currentBillingPlanTier"
  | "encryptionServicePlatformSelected"
  | "ssoSolutionChosen"
...
const logSSOSetupStep = ({
  currentBillingPlanTier,
  emailDomainError,
  emailDomainSubmittedCount,
  emailDomainValidatedCount,
  encryptionServicePlatformSelected,
  idpValidationResponse,
  ssoSetupStep,
  ssoSolutionChosen,
  ...
  logEvent(
    new UserSetupSsoEvent({
      ...
      idpValidationResponse:
        idpValidationResponse ?? IdpValidationResponse.Success,
      ssoSetupStep,
      ssoSolutionChosen,
...
export const logSelfHostedSSOSetupStep = (
  params: LogSelfHostedSSOSetupParams
) => {
  logSSOSetupStep({
    ...params,
