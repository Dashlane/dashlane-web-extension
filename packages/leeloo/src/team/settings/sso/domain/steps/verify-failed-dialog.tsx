...
export const VerifyFailedDialog = ({ onDismiss, domainName, }: VerifyFailedDialogProps) => {
    ...
    return (<Dialog isOpen onClose={onDismiss}>
      <DialogTitle title={dialogTitle}/>
      <DialogBody>{translate(I18N_KEYS.FAILURE_DESCRIPTION)}</DialogBody>
      <DialogFooter primaryButtonTitle={translate(I18N_KEYS.FAILURE_BUTTON)} primaryButtonOnClick={onDismiss} intent="primary"/>
    </Dialog>);
};
