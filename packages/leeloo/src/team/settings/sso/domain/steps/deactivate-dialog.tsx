...
export const DeactivateDomainDialog = ({
  domain,
  onConfirm,
  onDismiss,
}: DeactivateDomainDialogProps) => {
  ...
  return (
    <SimpleDialog
      ...
      footer={
        <DialogFooter
          primaryButtonTitle={translate(I18N_KEYS.BUTTON_REMOVE)}
          primaryButtonOnClick={handleConfirmClick}
          primaryButtonProps={{
            disabled: isAsync,
          }}
          secondaryButtonTitle={translate(I18N_KEYS.BUTTON_CANCEL)}
