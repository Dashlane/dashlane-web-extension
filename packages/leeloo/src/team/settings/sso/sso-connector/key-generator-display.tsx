...
import { Button, jsx, Tooltip } from '@dashlane/ui-components';
...
const I18N_KEYS = {
    ...
    GENERATOR_COPY_BUTTON_LABEL: 'team_settings_connector_generator_copy_button_label',
...
export const KeyGeneratorDisplay = ({ keyValue, onGenerateClicked, isGeneratorDisabled, generatorDisabledText, }: GeneratorProps) => {
    ...
    return (<Row label={translate(I18N_KEYS.GENERATOR_TITLE)} labelHelper={translate(I18N_KEYS.GENERATOR_DESCRIPTION)}>
      <div className={styles.generatorContainer}>
        <Tooltip content={generatorDisabledText} passThrough={!isGeneratorDisabled} sx={{ maxWidth: '210px' }}>
          <div className={isGeneratorDisabled ? styles.generatorDisableContent : ''}>
            <Button type="button" aria-describedby="errorKeyWarning" className={styles.generatorButton} onClick={generateKey} disabled={isGeneratorDisabled}>
              {translate(I18N_KEYS.GENERATOR_BUTTON)}
            </Button>
            <div className={styles.generatorInputContainer}>
              <InputWithCopyButton inputValue={keyValue} textInputProps={{
            readOnly: true,
            fullWidth: true,
            ...
            {showKeyWarning && (<p id="errorKeyWarning" className={styles.errorText}>
