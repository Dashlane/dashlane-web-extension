...
export const DisableSsoDialog = ({ closeDialog }: DialogProps) => {
    ...
    return (<SimpleDialog isOpen onRequestClose={() => closeDialog(DialogAction.dismiss)} footer={<DialogFooter primaryButtonTitle={translate(I18N_KEYS.DIALOG_ACTION)} primaryButtonOnClick={() => closeDialog(DialogAction.action)} secondaryButtonTitle={translate(I18N_KEYS.DIALOG_CANCEL)} secondaryButtonOnClick={() => closeDialog(DialogAction.dismiss)} intent="danger"/>} title={translate(I18N_KEYS.DIALOG_TITLE)}>
