...
import { DESKTOP_APP_NOT_SUPPORTED } from "../../../urls";
...
const I18N_KEYS = {
  ...
  DIALOG_DESCRIPTION:
    "team_settings_enable_sso_dialog_activate_description_markup",
...
export const EnableSsoDialog = ({ closeDialog }: DialogProps) => {
  ...
  const infoboxText = translate.markup(
    I18N_KEYS.INFOBOX_BUSINESS_TIER_WARNING,
    {
  ...
  return (
    <Dialog
      ...
      isOpen
      onClose={() => closeDialog(DialogAction.dismiss)}
    >
      <div className={styles.container}>
        ...
        <DialogBody>
          <div className={styles.toggleInfoBox}>
            {infoboxText && (
              <InfoBox severity="warning" size="small" title={infoboxText} />
            )}
          </div>
        </DialogBody>
        <DialogFooter
