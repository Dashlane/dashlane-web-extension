...
import { SSOSettingSectionProps } from 'team/settings/sso/types';
...
export const ConfigureIDP = ({ isTeamSettingsLoading, teamSettings, }: SSOSettingSectionProps) => {
    ...
    return (<div className={styles.configureIDPContainer}>
      <Row label={translate(I18N_KEYS.SSO_CONNECTOR_METADATA)} centerLabel>
        <InputWithCopyButton inputValue={ssoConnectorMetadata} textInputProps={{
            fullWidth: true,
            readOnly: true,
        }}/>
      </Row>
      <Row label={translate(I18N_KEYS.ENTITY_ID)} centerLabel>
        <InputWithCopyButton inputValue={entityID} textInputProps={{
            fullWidth: true,
            readOnly: true,
        }}/>
      </Row>
      <Row label={translate(I18N_KEYS.LOGIN_URL)} centerLabel>
        <InputWithCopyButton inputValue={loginURL} textInputProps={{
            fullWidth: true,
            readOnly: true,
        }}/>
      </Row>
