import { PropsOf, TextInput } from "@dashlane/ui-components";
import {
  ChangeEventHandler,
  FocusEventHandler,
  Key,
...
export const DomainField = ({
  ...
  endIcon,
  fieldName,
  feedbackType: externalFeedbackType,
  ...
  const feedbackType =
    externalFeedbackType ?? feedbackText ? "error" : undefined;
  ...
  return (
    <InputWithActionButton
      ...
      tooltipProps={{ passThrough: true }}
      replacementActions={actions}
    />
  );
};
