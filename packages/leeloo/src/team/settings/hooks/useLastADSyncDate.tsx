...
import { getLastADSyncDate, LastADSyncDateData, } from '../team-settings-services';
...
export function useLastADSyncDate(): UseLastADSyncDate {
    ...
    const [lastADSyncDateData, setLastADSyncDateData] = useState<LastADSyncDateData>();
    const [lastADSyncDateError, setLastADSyncDateError] = useState<Error | null>(null);
    const loadScimLastSyncDate = useCallback(async (abortController: AbortController) => {
        try {
