...
import {
  ChangeInviteLinkTeamKeySuccessData,
  CreateInviteLinkSuccessData,
  GetInviteLinkForAdminSuccessData,
  GetInviteLinkSuccessData,
  InviteLinkResponseFailure,
  RequestInviteLinkTokenSuccessData,
  ToggleInviteLinkSuccessData,
...
export function useInviteLinkData(): UseInviteLinkData {
  ...
  const [inviteLinkData, setInviteLinkData] =
    useState<GetInviteLinkSuccessData | null>(null);
  const [inviteLinkDataForAdmin, setInviteLinkDataForAdmin] =
    useState<GetInviteLinkForAdminSuccessData | null>(null);
  const [inviteLinkError, setInviteLinkError] = useState<
    InviteLinkResponseFailure["error"]["code"] | null
  >(null);
  const requestInviteLinkToken = useCallback(
    async (teamUuid: string, login: string) => {
      try {
