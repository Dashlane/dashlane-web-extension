...
import { getTeamInfo } from "../team-settings-services";
...
export function useTeamSettings(teamId: number | null): UseTeamSettings {
  ...
  const [teamSettingsError, setTeamSettingsError] =
    React.useState<Error | null>(null);
  const [teamCapabilities, setTeamCapabilities] =
    React.useState<TeamCapabilities | null>(null);
