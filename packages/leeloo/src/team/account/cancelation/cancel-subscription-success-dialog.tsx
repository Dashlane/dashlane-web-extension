...
const I18N_KEYS = {
  ...
  SUBSCRIPTION_ACTIVE_ITEM:
    "team_account_cancel_confirmation_dialog_paragraph_1_markup",
  REACTIVATE_SUBSCRIPTION_ITEM:
    "team_account_cancel_confirmation_dialog_paragraph_2",
};
interface Props {
  handleClose: () => void;
}
export const CancelSubscriptionConfirmationDialog = ({
  handleClose,
}: Props) => {
