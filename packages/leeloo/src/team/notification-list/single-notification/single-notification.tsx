...
export const SingleNotification = ({ level = AlertSeverity.SUCCESS, text, buttonTextKey, onClose, onLinkClick, onClickButton, }: Props) => {
    ...
    return (<div className={styles.notification}>
      <Alert severity={level} size={AlertSize.SMALL} showIcon closeIconName={translate('_common_alert_dismiss_button')} onClose={onClose} onAction={onClickButton ? onClickButton : undefined} actionText={buttonTextKey ? buttonTextKey : undefined}>
