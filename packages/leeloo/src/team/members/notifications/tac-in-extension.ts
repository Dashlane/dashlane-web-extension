...
import { WEBAPP_LOGIN } from 'team/urls';
...
export const showTacInExtensionNotification = ({ lee, setIsVaultNavigationModalOpen, }: ShowTacInExtensionNotificationParameters) => {
    const onClickButton = () => {
