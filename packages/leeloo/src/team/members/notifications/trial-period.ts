...
type ShowFreeTrialD0To15NotificationArguments = BaseFreeTrialNotificationArguments;
export const showFreeTrialD0To15Notification = ({ lee, spaceTier, translate, }: ShowFreeTrialD0To15NotificationArguments) => {
