...
const I18N_KEYS = {
    ...
    RIGHTS_CHANGE_MULTIPLE_ADMIN_MSG: 'team_members_assignment_multiple_dialog_admin_message',
    RIGHTS_CHANGE_MULTIPLE_GROUP_MANAGER_MSG: 'team_members_assignment_multiple_dialog_group_manager_message',
    RIGHTS_CHANGE_MULTIPLE_MEMBER_MSG: 'team_members_assignment_multiple_dialog_member_message',
    RIGHTS_CHANGE_MULTIPLE_SUBMIT: 'team_members_assignment_multiple_dialog_submit',
    RIGHTS_CHANGE_MULTIPLE_CANCEL: 'team_members_assignment_multiple_dialog_cancel',
    RIGHTS_CHANGE_MULTIPLE_PARTIAL_SUCCESS: 'team_members_assignment_multiple_partial_success',
...
export const MultipleRoleAssignmentDialog = ({ selectedMembers, newRole, updateUsersRights, closeDialog, }: {
    ...
    const updateSelectedUserRights = async () => {
        ...
        try {
            ...
            if (result.successes.length && result.errors.length) {
                alert.showAlert(translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_PARTIAL_SUCCESS, {
                ...
                alert.showAlert(translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_SUCCESS, {
                    count: result.successes.length,
                    newRole: newRoleTitle,
                }), AlertSeverity.SUCCESS);
            }
            else if (result.errors.length) {
                alert.showAlert(translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_ERROR, {
    ...
    return (<SimpleDialog isOpen footer={<DialogFooter intent="primary" primaryButtonTitle={translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_SUBMIT)} primaryButtonOnClick={updateSelectedUserRights} secondaryButtonTitle={translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_CANCEL)} secondaryButtonOnClick={closeDialog}/>} onRequestClose={closeDialog} title={translate(I18N_KEYS.RIGHTS_CHANGE_MULTIPLE_TITLE, {
