...
export const EnableInviteLinkDialog = ({
  closeDialog,
  ...
  const handleEnableInviteClick = async () => {
    ...
    alert.showAlert(
      translate(I18N_KEYS.INVITE_LINK_ACTIVATED_ALERT),
  ...
  return (
    <SimpleDialog
      ...
      footer={
        <DialogFooter
          intent="primary"
          primaryButtonTitle={translate(I18N_KEYS.INVITE_LINK_ACTIVATE)}
          primaryButtonOnClick={() => handleEnableInviteClick()}
          secondaryButtonTitle={translate(I18N_KEYS.INVITE_LINK_NOT_NOW)}
          secondaryButtonOnClick={closeDialog}
        />
      }
      onRequestClose={closeDialog}
      title={translate(I18N_KEYS.INVITE_LINK_ACTIVATE_TITLE)}
    >
      <Paragraph>
