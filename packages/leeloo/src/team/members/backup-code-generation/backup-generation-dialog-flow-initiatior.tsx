...
import { Dialog, DialogBody, DialogTitle, jsx } from '@dashlane/ui-components';
...
export const BackupCodeGenerationDialogFlowInitiator = ({ isOpen, memberLogin, closeBackupCodeDialog, }: Props) => {
    ...
    return (<Dialog isOpen={isOpen} closeIconName={errorOccured ? translate(I18N_KEYS.ERROR_CLOSE_BUTTON) : ''} onClose={() => {
            handleCloseBackupCodeDialogFlow();
        }}>
      {errorOccured ? (<BackupCodeGenerationDialogError handleClickOnRetry={handleClickOnRetry}/>) : recoveryCodes ? (<BackupCodeDialogGeneratedList memberLogin={memberLogin} recoveryCodes={recoveryCodes} handleClickOnDone={handleCloseBackupCodeDialogFlow}/>) : (<>
          <DialogTitle id="backup-code-generation-dialog-loader-title" title={translate(I18N_KEYS.LOADER_TITLE, {
