...
const I18N_KEYS = {
  ...
  ERROR_DESCRIPTION:
    "team_members_generate_recovery_codes_error_dialog_description",
  ERROR_TRY_AGAIN_BUTTON:
    "team_members_generate_recovery_codes_error_dialog_confirm_button",
};
export const BackupCodeGenerationDialogError = ({
  handleClickOnRetry,
}: Props) => {
  ...
  return (
    <>
      ...
      >
        <CrossCircleIcon
          color={colors.lightTheme.ds.text.danger.quiet}
          size={75}
        />
      </div>
      <DialogTitle
      ...
      <DialogBody>
        <Paragraph
          id="backup-code-generation-error-dialog-description"
          sx={{
      ...
      <DialogFooter
        primaryButtonTitle={translate(I18N_KEYS.ERROR_TRY_AGAIN_BUTTON)}
        primaryButtonProps={{
