...
export type MemberAction = 'reassign' | 'reactivate' | 'reinvite' | 'revoke' | 'reinviteAll' | 'generateBackupCode' | 'shareInviteLink' | 'enableInviteLink';
...
export type SortableMemberProps = 'login' | 'sortableLastActivity' | 'sortablePasswords' | 'sortableSafePasswords' | 'sortableWeakPasswords' | 'sortableReused' | 'sortableCompromisedPasswords' | 'sortableRights' | 'sortableSecurityScore';
