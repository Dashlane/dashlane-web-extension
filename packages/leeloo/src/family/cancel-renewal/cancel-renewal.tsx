...
const I18N_KEYS = {
    ...
    DESCRIPTION_IOS: 'family_invitee_page_confirm_renewal_message_description_ios',
    DESCRIPTION_MAC: 'family_invitee_page_confirm_renewal_message_description_mac',
    DESCRIPTION_PLAYSTORE: 'family_invitee_page_confirm_renewal_message_description_playstore',
    CANCEL_SUBSCRIPTION_BUTTON: 'family_invitee_page_confirm_renewal_message_button_title',
};
const BUTTON_URLS = {
...
const getButtonUrl = (platform: FamilyRenewalPlatform) => {
    ...
    else if (platform === FamilyRenewalPlatform.IOS_APP_STORE ||
...
export const CancelRenewal = ({ platform }: CancelRenewalProps) => {
    ...
    return (<div className={styles.wrapper}>
      ...
      <DangerButton size="small" classNames={[styles.button]} label={translate(I18N_KEYS.CANCEL_SUBSCRIPTION_BUTTON)} onClick={onCancelSubscription}/>
    </div>);
};
