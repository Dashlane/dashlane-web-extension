...
import { NewUserConsentFields } from "../new-user-consent-fields/new-user-consent-fields";
...
export const Terms = (props: TermsProps) => {
  ...
  const logoComponent = APP_PACKAGED_IN_EXTENSION ? (
    <div onClick={() => redirect(ACCOUNT_CREATION_URL_SEGMENT)} />
  ) : null;
  return (
    <div className={termsStyles.wrapper}>
