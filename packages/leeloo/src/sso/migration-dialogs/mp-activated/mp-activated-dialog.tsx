...
import { Dialog, DialogBody, DialogFooter, DialogTitle, MagicWandIcon, } from '@dashlane/ui-components';
    ...
    return (<Dialog closeIconName={translate(I18N_KEYS.CLOSE)} isOpen={isOpen} onClose={() => setIsOpen(false)}>
      <div className={styles.dialogContainer}>
        ...
        <DialogBody>
          ...
          <p className={classNames(styles.mpActivatedText, styles.mpActivatedSecondaryText)}>
            {translate.markup(I18N_KEYS.MP_ACTIVATED_TEXT_2)}
          </p>
        </DialogBody>
        <DialogFooter primaryButtonOnClick={() => setIsOpen(false)} primaryButtonTitle={translate(I18N_KEYS.MP_ACTIVATED_PRIMARY_BUTTON)}/>
      </div>
    </Dialog>);
};
