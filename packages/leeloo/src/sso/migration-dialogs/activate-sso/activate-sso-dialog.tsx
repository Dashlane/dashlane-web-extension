...
import { CloudKeyIcon, Dialog, DialogBody, DialogFooter, DialogTitle, OpenWebsiteIcon, } from '@dashlane/ui-components';
...
export const ActivateSSODialog = ({ activateLink, onClose, localSsoRedirect, isNitroSSO, nitroLoginCommand, }: ActivateSSOProps) => {
    ...
    return (<Dialog closeIconName={translate(I18N_KEYS.CLOSE)} isOpen={isOpen} onClose={handleOnClose} disableOutsideClickClose>
      <div className={styles.dialogContainer}>
        ...
        <DialogFooter primaryButtonOnClick={handleOpenUrl} primaryButtonTitle={translate(I18N_KEYS.ACTIVATE_SSO_PRIMARY_BUTTON)} secondaryButtonOnClick={() => openUrl(DASHLANE_BUSINESS_PLAN_SSO_LOGGING_IN)} secondaryButtonTitle={<>
