...
export const I18N_KEYS = {
    ...
    STEP_USERNAME_DELETE_INSTRUCTIONS: 'webapp_step_unsername_instructions_deletion',
    ...
    return (<>
      ...
      <Formik initialValues={{
        ...
        {(formikProps: FormikProps<FormFields>) => (<FlexContainer fullWidth flexDirection="column" gap="6" as={Form} autoComplete="off">
            <Field name="username">
              {({ field }: FormFieldProps<FormFields['username']>) => (<EmailField {...field} error={!!deletionError} readOnly={formikProps.isSubmitting && !deletionError} label={translate(I18N_KEYS.FORM_EMAIL_LABEL)} required feedback={{
                    text: deletionError ? translate(deletionError) : '',
                }}/>)}
            </Field>

            <Button sx={{ alignSelf: 'end' }} type="submit" mood="brand" intensity="catchy" size="large" isLoading={isLoading}>
