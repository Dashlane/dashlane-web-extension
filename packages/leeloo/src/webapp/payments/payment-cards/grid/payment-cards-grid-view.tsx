...
import { PaymentCardGridItem } from "../grid-item/payment-card-grid-item";
...
const PaymentCardsGridViewComponent = ({
  paymentCardsResult,
  cardRoute,
}: PaymentCardsGridViewProps) => {
  ...
  return (
    <>
      ...
      >
        {paymentCardsResult.items.map((paymentCard) => (
          <PaymentCardGridItem
            item={paymentCard}
            key={paymentCard.id}
            linkTo={cardRoute}
