import { colors, Paragraph } from "@dashlane/design-system";
  ...
  return (
    <>
      <Thumbnail
        ...
        text={translate(I18N_KEYS.BANK_ACCOUNTS_NAME)}
        iconColor={colors.lightTheme.ds.text.brand.quiet}
        size="small"
        backgroundColor={
          colors.lightTheme.ds.container.agnostic.neutral.standard
        }
      />
      <div
        sx={{
