...
import { BankAccountActions } from "../../bank-account-actions/bank-account-actions";
import { BankAccountActionsMode } from "../../bank-account-actions/types";
import { BankAccountInfo } from "../../bank-account-info/bank-account-info";
...
const BankAccountListItemComponent = ({
  bankAccount,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {bankAccount.lastUse && bankAccount.lastUse > 0 ? (
              <LocalizedTimeAgo date={fromUnixTime(bankAccount.lastUse)} />
            ) : (
              translate(I18N_KEYS.NEVER_USED)
            )}
          </Paragraph>
        </div>
      </Link>
      ...
      >
        <BankAccountActions
          bankAccount={bankAccount}
          mode={BankAccountActionsMode.LIST}
