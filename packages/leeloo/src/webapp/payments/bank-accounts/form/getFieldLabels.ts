...
const I18N_KEYS = {
    ...
    FIELD_PLACEHOLDER_NO_BIC: 'webapp_payment_edition_field_bank_account_no_BIC_placeholder',
    FIELD_PLACEHOLDER_NO_IBAN: 'webapp_payment_edition_field_bank_account_no_IBAN_placeholder',
    FIELD_ROUTING_NUMBER: 'webapp_payment_edition_field_bank_account_routing_number',
    FIELD_ACCOUNT_NUMBER: 'webapp_payment_edition_field_bank_account_account_number',
    ...
    FIELD_PLACEHOLDER_NO_ROUTING_NUMBER: 'webapp_payment_edition_field_bank_account_no_routing_number_placeholder',
    FIELD_PLACEHOLDER_NO_ACCOUNT_NUMBER: 'webapp_payment_edition_field_bank_account_no_account_number_placeholder',
    FIELD_PLACEHOLDER_NO_CLABE: 'webapp_payment_edition_field_bank_account_no_CLABE_placeholder',
    FIELD_PLACEHOLDER_NO_SORT_CODE: 'webapp_payment_edition_field_bank_account_no_sort_code_placeholder',
    ...
    ROUTING_NUMBER_COPIED: 'webapp_payment_alert_bank_account_routing_number_copied',
    ACCOUNT_NUMBER_COPIED: 'webapp_payment_alert_bank_account_account_number_copied'
};
