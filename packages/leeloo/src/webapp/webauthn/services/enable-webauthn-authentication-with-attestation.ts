...
import { startAttestation } from "../helpers/credential";
import { isRoamingCredential } from "../helpers/browserWebAuthnAuthentication";
export const enableWebAuthnAuthenticationWithAttestation = async (
