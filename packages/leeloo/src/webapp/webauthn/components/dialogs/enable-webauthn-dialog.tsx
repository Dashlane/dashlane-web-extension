...
import { Dialog, Heading, Infobox, Paragraph } from "@dashlane/design-system";
...
const I18N_KEYS = {
  ALL_AUTHENTICATORS_TITLE:
    "webapp_account_security_settings_passwordless_enable_all_authenticators_title",
  ALL_AUTHENTICATORS_DESC:
    "webapp_account_security_settings_passwordless_enable_all_authenticators_description",
  ALL_AUTHENTICATORS_BUTTON_ADD:
    "webapp_account_security_settings_passwordless_enable_all_authenticators_button_add",
  NO_PLATFORM_TITLE:
    "webapp_account_security_settings_passwordless_enable_noplatform_title",
  NO_PLATFORM_DESC:
    "webapp_account_security_settings_passwordless_enable_noplatform_description",
  NO_PLATFORM_BUTTON_ADD:
    "webapp_account_security_settings_passwordless_enable_noplaftorm_button_add",
  INFOBOX:
    "webapp_account_security_settings_passwordless_enable_all_authenticators_information_tip",
  BUTTON_CANCEL:
    "webapp_account_security_settings_passwordless_enable_button_cancel",
...
export const EnableWebAuthnDialog = ({
  userHasWebAuthnPlatformAuthenticator,
  onAddAuthenticator,
  onDismiss,
}: EnableWebAuthnDialogProps) => {
  ...
  return (
    <Dialog
      ...
      aria-describedby="enableDialogBody"
    >
