...
const I18N_KEYS = {
  ...
  BUTTON_REMOVE:
    "webapp_account_security_settings_passwordless_disable_button_remove",
  BUTTON_CANCEL:
    "webapp_account_security_settings_passwordless_disable_button_cancel",
  BUTTON_CLOSE_DIALOG: "_common_dialog_dismiss_button",
  INPUT_MASTER_PASSWORD:
    "webapp_account_security_settings_passwordless_disable_master_password",
  INPUT_ERROR:
    "webapp_account_security_settings_passwordless_disable_master_password_error",
  INPUT_PLACEHOLDER:
    "webapp_account_security_settings_passwordless_disable_master_password_placeholder",
  INPUT_BUTTON_SHOW:
    "webapp_account_security_settings_passwordless_disable_master_password_show",
  INPUT_BUTTON_HIDE:
...
export const DisableWebAuthnLastAuthenticatorDialog = ({
  onValidateMasterPassword,
  onRemoveAuthenticator,
  onDismiss,
}: DisableWebAuthnLastAuthenticatorDialogProps) => {
  ...
  return (
    <Dialog
      ...
      aria-describedby="disableDialogBody"
    >
      ...
      <form onSubmit={onSubmit}>
        <PasswordField
          label={translate(I18N_KEYS.INPUT_MASTER_PASSWORD)}
          ...
          error={currentPasswordErrorType === ErrorTypes.WRONG_PASSWORD_ERROR}
          feedback={{
            text:
