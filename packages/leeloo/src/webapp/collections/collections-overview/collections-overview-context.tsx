...
const CollectionsOverviewUpdateContext = createContext<UpdateContext>(
  {} as UpdateContext
);
const CollectionsOverviewProvider = ({ children }: Provider) => {
  ...
  return (
    <CollectionsOverviewContext.Provider value={contextValue}>
...
const useCollectionsOverviewContext = () =>
  useContext(CollectionsOverviewContext);
const useCollectionsOverviewUpdateContext = () =>
  useContext(CollectionsOverviewUpdateContext);
export {
  CollectionsOverviewProvider,
  useCollectionsOverviewContext,
  useCollectionsOverviewUpdateContext,
};
