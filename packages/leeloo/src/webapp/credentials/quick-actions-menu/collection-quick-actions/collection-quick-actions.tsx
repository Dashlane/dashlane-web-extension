...
import { AddToCollectionAction, AddToCollectionActionProps, } from './add-to-collection-action';
...
export const CollectionQuickActions = ({ itemSpaceId, ...rest }: AddToCollectionActionProps) => {
    return (<ActiveActionProvider>
