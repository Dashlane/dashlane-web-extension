...
const ActiveActionProvider = ({ children }: Provider) => {
    ...
    const toggleActiveAction = (actionType: ActionType) => setActiveAction((prevState) => prevState === actionType ? null : actionType);
    return (<ActiveActionContext.Provider value={{ activeAction, toggleActiveAction }}>
      {children}
