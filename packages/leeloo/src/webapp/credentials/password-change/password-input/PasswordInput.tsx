...
type PasswordInputPropsBase = React.ComponentPropsWithoutRef<
  typeof PasswordInputBase
>;
export type PasswordInputProps = Omit<
  PasswordInputPropsBase,
  ForbiddenProps
> & {
  credentialId?: string;
...
export const PasswordInput = (props: PasswordInputProps): JSX.Element => {
  ...
  const onPasswordVisibilityChangeHandler = React.useCallback(
  ...
  return (
    <PasswordInputBase
      {...prop}
      onPasswordVisibilityChangeRequest={onPasswordVisibilityChangeHandler}
    />
  );
};
