...
export const CredentialCreationWebsitesComponent = ({
  url,
  hasUrlError,
  handleMainWebsiteChange,
  handleChanges,
  ...
  const [isEditingLinkedWebsites, setIsEditingLinkedwebsites] =
  ...
  return (
    <WebsitesComponent
      ...
      isWebsiteFieldReadonly={false}
      editViewButtonEnabled={false}
      handleMainWebsiteChange={handleMainWebsiteChange}
      handleGoToWebsite={handleGoToWebsite}
    >
      <LinkedWebsitesList
        linkedWebsitesList={linkedWebsitesAddedByUser}
        areItemsLocked={false}
        credentialId={""}
        isListEditable={true}
        isEditing={isEditingLinkedWebsites}
