import { AnonymousRevealVaultItemFieldEvent, DomainType, hashDomain, ItemType, UserRevealVaultItemFieldEvent, Field as VaultItemField, } from '@dashlane/hermes';
...
export const logRevealPassword = async (url: string, id: string, autoProtected?: boolean, credentialsGloballyRequireMP?: boolean) => {
    ...
    if (id) {
        ...
        logEvent(new AnonymousRevealVaultItemFieldEvent({
            field: VaultItemField.Password,
            itemType: ItemType.Credential,
            domain: {
