...
import { GeneratePasswordResult, PasswordGenerationSettings, } from '@dashlane/communication';
...
export const GeneratePasswordCard = ({ generatorSettings, setGeneratorSettings, handleChangePassword, handleClose, }: GeneratePasswordButtonProps) => {
    const generateNewPassword = (passwordSettings: PasswordGenerationSettings) => {
        carbonConnector
            ...
            .finally(() => {
            logEvent(new UserGeneratePasswordEvent({
    ...
    return (<ContentCard additionalSx={{
            backgroundColor: 'ds.container.agnostic.neutral.quiet',
            marginTop: '8px',
        }}>
      <GeneratorSettings options={generatorSettings} handleSettingsChange={handleSettingsChange} handleGenerateNewPassword={handleRefreshPassword} handleClose={handleClose}/>
    </ContentCard>);
};
