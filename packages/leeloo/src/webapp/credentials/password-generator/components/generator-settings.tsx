...
const I18N_KEYS = {
    GENERATE_ANOTHER_PWD: 'webapp_credential_edition_button_generate_another_password',
    CLOSE_GENERATOR: 'webapp_credential_edition_button_close_password_generator',
};
export const GeneratorSettings = ({ options, handleSettingsChange, handleGenerateNewPassword, handleClose, }: GeneratorSettingsProps) => {
    ...
    return (<GridContainer gap="10px" sx={{ padding: '10px' }}>
      <GridContainer gap="10px" sx={{
            textAlign: 'left',
            padding: '10px',
            borderRadius: '4px',
        }}>
      ...
      <Button fullsize mood="brand" intensity="catchy" onClick={handleGenerateNewPassword}>
