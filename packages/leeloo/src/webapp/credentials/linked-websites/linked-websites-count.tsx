...
const I18N_KEYS = {
  LINKED_WEBSITES_COUNT:
    "webapp_credential_edition_linked_websites_title_with_count",
};
interface LinkedWebsitesCountProps {
  totalLinkedWebsitesLength: number;
}
export const LinkedWebsitesCount = ({
  totalLinkedWebsitesLength,
}: LinkedWebsitesCountProps) => {
  const { translate } = useTranslate();
  return totalLinkedWebsitesLength > 0 ? (
    <Paragraph
