...
const I18N_KEYS = {
    ...
    DIALOG_DESCRIPTION: 'webapp_credential_linked_websites_discard_dialog_description_markup',
...
export const LinkedWebsitesDataLossPreventionDialog = ({ onCancel, onLeavePageWithoutSaving, }: Props) => {
    const { translate } = useTranslate();
    return (<SimpleDialog isOpen showCloseIcon title={translate(I18N_KEYS.DIALOG_TITLE)} onRequestClose={onCancel} footer={<FlexContainer justifyContent="end" gap="8px">
