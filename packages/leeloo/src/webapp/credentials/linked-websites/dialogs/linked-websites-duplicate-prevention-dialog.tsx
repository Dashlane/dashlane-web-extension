...
const I18N_KEYS = {
  DIALOG_DUPLICATE_PREVENTION_TITLE_ONE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_title_one",
  DIALOG_DUPLICATE_PREVENTION_DESCRIPTION_ONE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_description_one",
  ADD_WEBSITES_ONE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_add_websites_one",
  DIALOG_DUPLICATE_PREVENTION_TITLE_MULTIPLE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_title_multiple",
  DIALOG_DUPLICATE_PREVENTION_DESCRIPTION_MULTIPLE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_description_multiple",
  ADD_WEBSITES_MULTIPLE:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_add_websites_multiple",
  CANCEL:
    "webapp_credential_linked_websites_duplicate_prevention_dialog_cancel",
};
export const LinkedWebsitesDuplicateDialog = ({
  duplicateData,
  onCancel,
  onSave,
}: Props) => {
  ...
  return (
    ...
    >
      <div>
        ...
        {hasMultiplePotentialDuplicates ? (
          <ul className={styles.duplicatesList}>
            {duplicateData.map((duplicate) => (
              <li
                key={duplicate.linkedWebsite}
