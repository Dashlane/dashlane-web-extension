...
export const useSortingOptions = (
  storageKey = CREDENTIALS_LIST_SORTING_OPTIONS
) => {
  ...
  const saveSortingOptionsInStorage = (newSortingOptions: SortingOptions) =>
    localStorage.setItem(storageKey, JSON.stringify(newSortingOptions));
