...
export const CredentialsListEmptyView = () => {
    ...
    return (<EmptyView title={translate(I18N_KEYS.EMPTY_VIEW_TITLE)} icon={<Icon name="ItemLoginOutlined" color="ds.text.neutral.standard" sx={{ width: '64px', minWidth: '64px', height: '64px' }}/>}>
      ...
      <FlexContainer gap={4} justifyContent="center" sx={{ marginTop: '16px' }}>
        <Button layout="iconLeading" icon="ActionAddOutlined" onClick={onClickAddNew} disabled={passwordLimitDataLoading}>
