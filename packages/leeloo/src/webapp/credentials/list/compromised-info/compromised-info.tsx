...
export const CompromisedInfo = ({ compromised }: CompromisedInfoProps) => {
    ...
    return compromised ? (<div sx={{
            marginRight: '48px',
            whiteSpace: 'normal',
        }}>
      <Icon name="FeedbackWarningOutlined" size="large" color="ds.text.danger.quiet" aria-label={translate(I18N_KEYS.COMPROMISED_TOOLTIP)} tooltip={translate(I18N_KEYS.COMPROMISED_TOOLTIP)}/>
    </div>) : null;
};
