...
export const ProtectedItemsUnlockedDialog = ({
  onDismiss,
  onSuccess,
}: Props) => {
  ...
  return (
    <SimpleDialog
      ...
      footer={
        <DialogFooter
          intent="primary"
          primaryButtonTitle={translate(CONTINUE_BUTTON_TYPE_KEY_MAP.VERIFIED)}
          primaryButtonOnClick={onSuccess}
          secondaryButtonTitle={translate(I18N_KEYS.DISMISS)}
