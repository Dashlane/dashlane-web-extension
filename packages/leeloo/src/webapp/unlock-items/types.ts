...
export type UnlockRequestTranslationOptions = UnlockRequestOptionsNotTranslated | UnlockRequestOptionsTranslated;
...
export interface OtherUnlockRequest {
    itemType: LockedItemType.BankAccount | LockedItemType.CreditCard | LockedItemType.Secret | LockedItemType.SecureNote | LockedItemType.SecureNoteSetting | LockedItemType.ExportData | LockedItemType.SecuritySettings | LockedItemType.UpdateContactEmail | LockedItemType.GeneratedPassword | LockedItemType.SharedItems;
}
export type UnlockRequest = BaseUnlockRequest & (CredentialUnlockRequest | OtherUnlockRequest);
