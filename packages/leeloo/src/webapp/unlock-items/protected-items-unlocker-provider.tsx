...
import { ProtectedItemsUnlockerManager } from 'webapp/unlock-items/protected-items-unlocker-manager';
...
export const ProtectedItemsUnlockerContext = createContext<ProtectedItemsUnlockerProps>({
    openProtectedItemsUnlocker: () => { },
    areProtectedItemsUnlocked: false,
    protectedItemsUnlockerShown: false,
});
export const ProtectedItemsUnlockerProvider = ({ children, }: PropsWithChildren<unknown>) => {
    ...
    return (<ProtectedItemsUnlockerContext.Provider value={contextValue}>
      {children}
      {unlockRequest ? (<ProtectedItemsUnlockerManager unlockRequest={unlockRequest} setUnlockRequest={setUnlockRequest}/>) : null}
