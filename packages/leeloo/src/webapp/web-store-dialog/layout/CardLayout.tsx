...
export const CardLayout = ({ children, displayHeaderLogo, domain, headerBackLink, onClose, title, withoutHeader, }: Props) => {
    return (<div sx={containerStyles}>
      {withoutHeader ? null : (<Header backLink={headerBackLink} displayLogo={displayHeaderLogo} domain={domain} title={title} onClose={onClose}/>)}
