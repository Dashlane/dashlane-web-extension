...
import { CloseIcon, colors, DashlaneLogoIcon, Heading, jsx, ThemeUIStyleObject, } from '@dashlane/ui-components';
...
export const Header = ({ backLink, displayLogo, domain, title, onClose, }: Props) => {
    const { translate } = useTranslate();
    return (<header sx={headerStyles}>
      ...
      {onClose ? (<button type="button" sx={actionStyles} onClick={onClose} aria-label={translate('closeWindow')}>
