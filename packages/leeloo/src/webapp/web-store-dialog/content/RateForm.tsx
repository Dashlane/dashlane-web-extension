  ...
  return (
    ...
    >
      <Flex justifyContent="space-between">
        <FaceButton
          text={translate(I18N_KEYS.RESPONSE_BAD)}
          faceHoverColor={colors.red02}
          icon={<SadFaceIcon size={36} />}
          onClick={() => {
            formResponse(RateFormResponse.Bad);
          }}
        />
        <FaceButton
          text={translate(I18N_KEYS.RESPONSE_OKAY)}
          faceHoverColor={colors.dashGreen03}
          icon={<NeutralFaceIcon size={36} />}
          onClick={() => {
            formResponse(RateFormResponse.Okay);
          }}
        />
        <FaceButton
          text={translate(I18N_KEYS.RESPONSE_GREAT)}
          faceHoverColor={colors.validatorGreen}
          icon={<HappyFaceIcon size={36} />}
          onClick={() => {
