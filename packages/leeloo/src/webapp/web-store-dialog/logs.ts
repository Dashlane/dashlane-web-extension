...
export const logRateUsChromeStorePageView = () =>
  logPageView(PageView.ReviewRateUsChromeWebStore);
...
export const logG2RatingWebsiteOpen = () =>
  logEvent(
    new UserCallToActionEvent({
...
export const logChromeStoreOpen = () =>
  logEvent(
    new UserCallToActionEvent({
