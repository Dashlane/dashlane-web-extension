...
import {
  ...
  Heading,
  IdentityRestaurationIcon as IdentityRestorationIcon,
  IdentityTheftIcon,
...
const I18N_KEYS = {
  ...
  CREDIT_MONITORING_DESCRIPTION:
    "webapp_premium_plus_credit_monitoring_description_markup",
  CREDIT_MONITORING_TITLE: "webapp_premium_plus_credit_monitoring_title",
  IDENTITY_RESTAURATION_BUTTON:
    "webapp_premium_plus_identity_restauration_button",
  IDENTITY_RESTAURATION_DESCRIPTION:
    "webapp_premium_plus_identity_restauration_description_markup",
  IDENTITY_RESTAURATION_TITLE:
    "webapp_premium_plus_identity_restauration_title",
  IDENTITY_THEFT_BUTTON: "webapp_premium_plus_identity_theft_button",
  IDENTITY_THEFT_DESCRIPTION:
    "webapp_premium_plus_identity_theft_description_markup",
  IDENTITY_THEFT_TITLE: "webapp_premium_plus_identity_theft_title",
};
const URL_KEYS = {
  CREDIT_MONITORING: "__REDACTED__",
  IDENTITY_THEFT: "__REDACTED__",
  IDENTITY_RESTAURATION: "__REDACTED__",
};
const DEFAULT_TRACKING = {
  type: "",
  action: "",
};
const PremiumPlusSection = ({
  button,
  shouldDisplay,
  description,
  title,
  ...
  return shouldDisplay ? (
    <section className={styles.premiumPlusSection}>
      <div>
    ...
    <PersonalDataSectionView>
      ...
      <div className={styles.rootContainer}>
        <div className={styles.premiumPlusContainer}>
          <PremiumPlusSection
            icon={<CreditMonitoringIcon size={52} />}
            companyIcon={TransunionIcon}
            description={translate.markup(
              I18N_KEYS.CREDIT_MONITORING_DESCRIPTION
            )}
            title={translate(I18N_KEYS.CREDIT_MONITORING_TITLE)}
            shouldDisplay={shouldDisplayCapability("creditMonitoring")}
            button={
              <Button
                type="button"
                nature="secondary"
                onClick={() =>
                  openDashlaneUrl(URL_KEYS.CREDIT_MONITORING, DEFAULT_TRACKING)
                }
              >
          ...
          <PremiumPlusSection
            icon={<IdentityTheftIcon size={47} />}
            companyIcon={AigIcon}
            description={translate.markup(I18N_KEYS.IDENTITY_THEFT_DESCRIPTION)}
            title={translate(I18N_KEYS.IDENTITY_THEFT_TITLE)}
            shouldDisplay={shouldDisplayCapability("identityTheftProtection")}
            button={
              <Button
                type="button"
                nature="secondary"
                onClick={() =>
                  openDashlaneUrl(URL_KEYS.IDENTITY_THEFT, DEFAULT_TRACKING)
                }
              >
          ...
          <PremiumPlusSection
            icon={<IdentityRestorationIcon size={52} />}
            companyIcon={TransunionIcon}
            description={translate.markup(
              I18N_KEYS.IDENTITY_RESTAURATION_DESCRIPTION
            )}
            title={translate(I18N_KEYS.IDENTITY_RESTAURATION_TITLE)}
            shouldDisplay={shouldDisplayCapability("identityRestoration")}
            button={
              <Button
                type="button"
                nature="secondary"
                onClick={() =>
                  openDashlaneUrl(
                    URL_KEYS.IDENTITY_RESTAURATION,
                    DEFAULT_TRACKING
                  )
                }
              >
