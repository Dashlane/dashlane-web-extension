...
import { Icon, jsx, Paragraph, ThemeUIStyleObject, } from '@dashlane/design-system';
...
export const SharingInviteItemSelect = ({ id, roles, onRolesChanged, isStarterAdmin, }: SharingInviteItemSelectProps) => {
    ...
    const roleOptions: RoleSelectOption[] = [
        ...
        },
        {
            ...
            </Paragraph>} hasIcon={true} isStarterAdmin={isStarterAdmin}/>),
    ...
    return (<div sx={{
      ...
      <Icon name="FeedbackInfoOutlined" size="medium" tooltip={translate(I18N_KEYS.SELECT_DROPDOWN_INFOBOX)} color="ds.border.brand.standard.active"/>

      <SelectDropdownMenu name="roleSelect" id="role-select" isSearchable={false} menuPortalTarget={document.body} value={getSelectValue} options={roleOptions} onChange={(newRole) => handleSelectedRole(newRole?.value ?? SharedCollectionRole.Editor)} customStyles={{
            menuPortal: (base) => ({
                ...base,
                zIndex: 150,
            }),
