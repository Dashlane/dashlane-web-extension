...
export const SharingSuccess = ({
  ...
  return (
    <>
      <DialogTitle
        title={translate(I18N_KEYS.SUCCESS, { count: itemsCount })}
      />
      <DialogBody>
        <Paragraph>
      ...
      <DialogFooter
        primaryButtonTitle={translate(I18N_KEYS.DISMISS)}
        primaryButtonOnClick={onDismiss}
        primaryButtonProps={{ disabled: isLoading, type: "button" }}
      />
    </>
  );
};
