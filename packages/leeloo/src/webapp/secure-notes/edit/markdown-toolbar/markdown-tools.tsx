...
const basicSelectionRangeUpdate = (
  selection: MarkdownContentSelection,
  isFormatted: boolean,
...
const linkSelectionRangeUpdate = (
  selection: MarkdownContentSelection,
  cursorOffsetStart: number,
  cursorOffsetEnd: number
): MarkdownContentSelection => {
...
const basicFormatter =
  ...
  (text: string, selection: MarkdownContentSelection): FormatterResult => {
    ...
    const isFormatted = textIsFormatted(
      textToFormat,
      formatPrefix,
      formatSuffix
    );
    const selectionRangeUpdate = basicSelectionRangeUpdate(
      selection,
      isFormatted,
      cursorOffsetStart,
      cursorOffsetEnd
