...
import { SecureNoteView } from '../types';
...
export const NoteTitle = ({ note, showTitleIcons = true, tag, }: NoteTitleProps) => {
    ...
    return (<div sx={{
      ...
      <div sx={{
        ...
        <div sx={{
          ...
          <IntelligentTooltipOnOverflow tooltipText={note.title} sx={{
            whiteSpace: 'nowrap',
        }}>
          ...
          {sharingData?.isShared && showTitleIcons ? (<span role="img" aria-hidden sx={SX_STYLES.ICON}>
              <Icon name="SharedOutlined" size="xsmall" color="ds.text.neutral.quiet"/>
            </span>) : null}

          {note.hasAttachments && showTitleIcons ? (<span role="img" aria-hidden sx={SX_STYLES.ICON}>
              <Icon name="AttachmentOutlined" size="xsmall" color="ds.text.neutral.quiet"/>
            </span>) : null}

          {note.isSecured && showTitleIcons ? (<span role="img" aria-hidden sx={SX_STYLES.ICON}>
