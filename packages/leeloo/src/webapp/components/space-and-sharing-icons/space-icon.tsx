...
export const CustomSpaceIcon = ({ color = DEFAULT_COLOR, letter }: Props) => (<svg xmlns="*****" xmlnsXlink="*****" width="20" height="20" viewBox="0 0 18 18" className={styles.spacedIcon}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <text fill="#FFF" fontFamily={globalFontVars['--dashlane-fontfamily-primary']} fontSize="10" fontWeight="600">
...
export const SpaceIcon = ({ space }: {
    space: SpaceEntry;
}) => space.id === null ? (<img src={allSpacesIcon} alt={space.name}/>) : (<CustomSpaceIcon color={space.color} letter={space.letter}/>);
