...
export const DarkWebMonitoringPaywall = ({
  mode,
  closePaywall,
  ...
  return (
    <GenericPaywall
      ...
      description="webapp_paywall_dark_web_monitor_dialog_subtitle"
      paywallFeatures={DWM_FEATURES}
      mode={mode}
      paywallType={PAYWALL_SUBTYPE.DARKWEB_MONITORING}
      title="webapp_paywall_dark_web_monitor_dialog_title"
