...
import { colors, FolderIcon, PaperClipIcon, SharingCenterIcon, } from '@dashlane/ui-components';
...
export const SecureNotesPaywall = ({ mode, closePaywall, }: Pick<PaywallProps, 'mode' | 'closePaywall'>) => {
    return (<GenericPaywall paywallType={PAYWALL_SUBTYPE.SECURE_NOTES} title="webapp_paywall_secure_note_title" description="webapp_paywall_secure_note_description" mode={mode} closePaywall={closePaywall} paywallFeatures={SECURE_NOTES_FEATURES} target={PaywallTarget.Premium} withDefaultFooter/>);
};
