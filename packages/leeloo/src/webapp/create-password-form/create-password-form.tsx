...
import { Button, Flex, PasswordField } from "@dashlane/design-system";
...
export const CreatePasswordForm = ({
  ...
  return (
    ...
    >
          ...
          >
            <PasswordField
              ...
              placeholder={
                createPasswordPlaceholderLabel
                  ? createPasswordPlaceholderLabel
                  : translate(I18N_KEYS.CREATE_PASSWORD_HINT_TEXT)
              }
              value={createPasswordValue}
              label={
                createPasswordInputLabel
                  ? createPasswordInputLabel
                  : translate(I18N_KEYS.CREATE_PASSWORD_FLOATING_LABEL)
              }
              error={!!createPasswordErrorType}
              feedback={
                ...
                passwordStrength
                  ? {
                      ...
                      description: translate(
                        `account_creation_${
                          ZXCVBN_SCORE_TRANSLATION_MAPPING[
              ...
              aria-describedby={passwordFieldId}
            />
          </PasswordStrengthTooltip>
        </div>
        <PasswordField
          ...
          placeholder={
            confirmPasswordPlaceholderLabel
              ? confirmPasswordPlaceholderLabel
              : translate(I18N_KEYS.CONFIRM_PASSWORD_HINT_TEXT)
          }
          ...
          label={
            confirmPasswordInputLabel
              ? confirmPasswordInputLabel
              : translate(I18N_KEYS.CONFIRM_PASSWORD_FLOATING_LABEL)
          }
          feedback={
      ...
      <Flex sx={{ marginTop: "24px" }} justifyContent="flex-end" gap="8px">
        {secondaryButtonTitle ? (
          <Button onClick={onDismiss} mood="neutral" intensity="quiet">
            {secondaryButtonTitle}
          </Button>
        ) : undefined}
