...
import dashlaneIcon from "../../images/dashlaneLogo.svg";
...
const infoCircleIcon = (
  <InfoCircleIcon color={colors.dashGreen00} size={16} viewBox="0 2 20 20" />
);
const mobileIcon = (
  <MobileIcon color={colors.dashGreen02} size={24} viewBox="0 2 40 40" />
);
const backArrowIcon = (
...
export const ScanQRCode = () => {
  ...
  const tooltipContent = `${translate(
    "web_onboarding_card_add_mobile_warning_hover_pt_1"
  )}
