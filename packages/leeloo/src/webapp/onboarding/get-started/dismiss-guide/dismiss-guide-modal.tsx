...
const I18N_KEYS = {
  ...
  DISMISS_MODAL_ACTION_DISMISS:
    "onb_vault_get_started_dismiss_modal_action_primary",
  DISMISS_MODAL_ACTION_CANCEL:
    "onb_vault_get_started_dismiss_modal_action_secondary",
  DISMISS_MODAL_ACTION_CLOSE:
    "onb_vault_get_started_dismiss_modal_action_close",
};
export const DismissGuideModal = ({
  isOpen,
  setShowDismissGuideModal,
}: DismissGuideModalProps) => {
  ...
  return (
    <Dialog
      ...
      closeActionLabel={translate(I18N_KEYS.DISMISS_MODAL_ACTION_CLOSE)}
      isDestructive
      onClose={onCloseHandler}
      title={translate(I18N_KEYS.DISMISS_MODAL_TITLE)}
    >
