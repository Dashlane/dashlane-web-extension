...
const ButtonRow = (props: HTMLProps<HTMLDivElement>) => (
  <div sx={{ display: "flex", gap: "8px", marginLeft: "8px" }} {...props} />
);
export const NotificationActions = ({
  ...
  onCancelRefusal,
  onAccepted,
  acceptedTranslationKey = I18N_KEYS.ACCEPT_SUCCEEDED,
  ...
  switch (notificationStatus) {
    ...
    case NotificationStatus.AcceptJustSucceeded:
      return (
        <ActionResult
          nature="success"
          text={translate(acceptedTranslationKey)}
        />
      );
    ...
    case NotificationStatus.RefusalFailed:
      return (
        <ActionResult
          nature="failure"
          text={translate(I18N_KEYS.ACTION_FAILED)}
        />
      );
    case NotificationStatus.Unshared:
      return (
        <ActionResult
          nature="failure"
          text={translate(I18N_KEYS.SENDER_CANCELLED)}
        >
          <Button
            aria-label={translate(I18N_KEYS.COMMON_DISMISS)}
            icon="ActionCloseOutlined"
            intensity="supershy"
            layout="iconOnly"
            mood="neutral"
            size="small"
            onClick={() => onRemoveUnshared(notificationId)}
            sx={{ marginLeft: "8px" }}
          />
        </ActionResult>
      );
      ...
      return (
        <ButtonRow>
          <Button
            mood="danger"
            size="small"
            onClick={() => onConfirmRefusal(notificationId)}
          >
            {translate(I18N_KEYS.REFUSE)}
          </Button>
          <Button
            ...
            mood="brand"
            size="small"
            onClick={() => onCancelRefusal(notificationId)}
          >
      ...
      return (
        <ButtonRow>
          <Button
            ...
            mood="danger"
            size="small"
            onClick={() => onRefusePending(notificationId)}
          >
            {translate(I18N_KEYS.REFUSE)}
          </Button>
          <Button
            ...
            mood="brand"
            size="small"
            onClick={() => onAcceptPending(notificationId)}
          >
            {translate(I18N_KEYS.ACCEPT)}
          </Button>
        </ButtonRow>
