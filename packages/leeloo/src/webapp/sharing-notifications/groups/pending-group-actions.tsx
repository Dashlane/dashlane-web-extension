...
export const PendingGroupActions = ({ notification, acceptPendingUserGroup, refusePendingUserGroup, removeUnsharedUserGroup, confirmRefusePendingUserGroup, cancelRefusePendingUserGroup, }: PendingGroupActionsProps) => {
    return (<NotificationActions notificationId={notification.id} notificationStatus={notification.status} onAcceptPending={acceptPendingUserGroup} onRefusePending={refusePendingUserGroup} onRemoveUnshared={removeUnsharedUserGroup} onConfirmRefusal={confirmRefusePendingUserGroup} onCancelRefusal={cancelRefusePendingUserGroup} acceptedTranslationKey={'webapp_sharing_notifications_accept_group_succeeded'}/>);
};
