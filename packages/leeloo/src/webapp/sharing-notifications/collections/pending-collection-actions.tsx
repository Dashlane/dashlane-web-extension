...
export const PendingCollectionActions = ({ notification, acceptPendingCollection, refusePendingCollection, removeUnsharedCollection, confirmRefusePendingCollection, cancelRefusePendingCollection, routes, }: PendingCollectionActionsProps) => {
    return (<NotificationActions notificationId={notification.id} notificationStatus={notification.status} onAcceptPending={acceptPendingCollection} onRefusePending={refusePendingCollection} onRemoveUnshared={removeUnsharedCollection} onConfirmRefusal={confirmRefusePendingCollection} onCancelRefusal={cancelRefusePendingCollection} onAccepted={() => {
