...
export const PasskeyEditPanelComponent = ({
  item,
}: PasskeyEditComponentProps) => {
  ...
  const changeSpaceValueIfForcedDomainsEnabled = () => {
    if (
      ...
      const associatedPasskeyEmailDomain =
        passkey.userDisplayName?.split("@")[1];
      if (
        spaceDetails.info.teamDomains.includes(associatedPasskeyEmailDomain)
      ) {
  ...
  return (
    ...
    >
      <PasskeyForm
        ...
        signalEditedValues={handleEditForm}
