...
import { Button, DSCSSObject, Heading } from "@dashlane/design-system";
...
const ANIMATION_DURATION_MS = parseInt(
  cssVariables["--edit-panel-animation-duration-enter"],
  10
);
export const AccountSubPanel = ({
  headingText,
    ...
    >
      <div sx={HEADER_STYLE}>
        <Button
          ...
          aria-label={translate(I18N_KEYS.BACK_BUTTON)}
        />
        <Heading
          as="h2"
          textStyle="ds.title.section.medium"
          color="ds.text.neutral.catchy"
          aria-labelledby={headingAriaLabelledby}
        >
          {headingText}
        </Heading>
      </div>
