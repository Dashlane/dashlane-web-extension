...
const I18N_KEYS = {
    BIOMETRIC_RECOVERY_TITLE: 'webapp_account_security_settings_account_recovery_section_biometric_recovery_title',
    BIOMETRIC_RECOVERY_DESCRIPTION: 'webapp_account_security_settings_account_recovery_section_biometric_recovery_description',
    MOBILE_ONLY_BADGE: '_common_settings_mobile_only_feature_badge',
};
export const BiometricRecoverySection = () => {
    const { translate } = useTranslate();
    return (<SettingsSection sectionTitle={translate(I18N_KEYS.BIOMETRIC_RECOVERY_TITLE)}>
