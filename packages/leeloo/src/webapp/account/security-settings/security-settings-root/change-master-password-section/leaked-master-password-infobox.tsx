...
const I18N_KEYS = {
  TITLE:
    "webapp_account_security_settings_changemp_section_leaked_master_password_title",
  DESCRIPTION:
    "webapp_account_security_settings_changemp_section_leaked_master_password_description",
  BLOG_LINK:
    "webapp_account_security_settings_changemp_section_leaked_master_password_blog_link",
};
