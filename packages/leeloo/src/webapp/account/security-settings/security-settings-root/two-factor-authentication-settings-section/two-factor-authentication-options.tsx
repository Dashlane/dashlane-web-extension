...
import { colors, ForwardIcon, jsx, Link } from '@dashlane/ui-components';
import { ActivePanel } from 'webapp/account/security-settings/security-settings';
const I18N_KEYS = {
    TWO_FACTOR_AUTHENTICATION_OPTIONS: 'webapp_account_security_settings_two_factor_authentication_options',
};
type Props = {
...
export const TwoFactorAuthenticationOptions = ({ changeActivePanel, }: Props) => {
    ...
    return (<Link href="#" role="button" sx={SX_STYLES.BUTTON} onClick={handleOnClick}>
