    ...
    <div>
      <TransitionGroup>
        {activePanel === ActivePanel.Root ? (
          ...
          >
            <SecuritySettingsRoot
              key="for-TransitionGroup-security-settings-root"
              onNavigateOut={onNavigateOut}
              changeActivePanel={setActivePanel}
              onDialogStateChanged={onDialogStateChanged}
            />
          </CSSTransition>
        ) : null}
        {activePanel === ActivePanel.ChangeMP ? (
          <CSSTransition
            classNames={subPanelTransitionStyles}
            timeout={panelAnimationDurationMs}
          >
            <ChangeMasterPasswordRoot
              key="for-TransitionGroup-security-settings-subpanel-changemp"
        ...
        {activePanel === ActivePanel.TwoFactorAuthentication ? (
          <CSSTransition
            classNames={subPanelTransitionStyles}
            timeout={panelAnimationDurationMs}
          >
            <TwoFactorAuthenticationRoot
              key="for-TransitionGroup-security-settings-subpanel-account-recovery"
              onNavigateOut={onSubPanelExitRequest}
            />
          </CSSTransition>
        ) : null}
        {activePanel === ActivePanel.WebAuthn ? (
          <CSSTransition
            classNames={subPanelTransitionStyles}
            timeout={panelAnimationDurationMs}
          >
            <WebAuthnRoot
              key="for-TransitionGroup-security-settings-subpanel-webauthn"
              onNavigateOut={onSubPanelExitRequest}
              onDialogStateChanged={onDialogStateChanged}
            />
          </CSSTransition>
