...
import { WebAuthnAuthenticator } from "../webauthn-auhenticator/webauthn-authenticator";
...
const I18N_KEYS = {
  ALL_AUTHENTICATORS_ADD_BUTTON:
    "webapp_account_security_settings_passwordless_login_methods_all_authenticators_add",
  NO_PLATFORM_ADD_BUTTON:
    "webapp_account_security_settings_passwordless_login_methods_noplatform_add",
  LOGIN_METHODS_TITLE:
    "webapp_account_security_settings_passwordless_login_methods_title",
  TITLE_PLATFORM:
    "webapp_account_security_settings_passwordless_login_methods_plaftorm",
  TITLE_ROAMING:
    "webapp_account_security_settings_passwordless_login_methods_roaming",
};
export const LoginMethods = ({
  ...
  const getAuthenticatorsWithName = (
    authenticatorsData: AuthenticatorDetails[]
  ...
  return (
    <SettingsSection
      sectionTitle={translate(I18N_KEYS.LOGIN_METHODS_TITLE)}
      action={
        <IconButton
          type="button"
          size="small"
          onClick={onClickTriggerWebAuthnAuthenticator}
          aria-label={translate(addButtonTitle)}
          title={translate(addButtonTitle)}
        ...
        {data.map((authenticator: AuthenticatorDetails) => {
          return (
            <WebAuthnAuthenticator
              ...
              onRemoveAuthenticator={onRemoveWebAuthnAuthenticator}
            />
          );
        })}
      </ol>
