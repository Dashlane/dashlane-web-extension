...
const I18N_KEYS = {
  METHODS_MENU_TITLE:
    "webapp_account_security_settings_passwordless_login_methods_menu_title",
  METHODS_MENU_DELETE:
    "webapp_account_security_settings_passwordless_login_methods_menu_delete",
  METHODS_MENU_RENAME:
    "webapp_account_security_settings_passwordless_login_methods_menu_rename",
  METHODS_MENU_ACTIVITY:
    "webapp_account_security_settings_passwordless_login_methods_menu_activity",
};
export const WebAuthnAuthenticator = ({
  ...
  const dropdownActionButtons = (
    <DropdownElement onClick={onRemove}>
  ...
  return (
    <li className={styles.authenticator}>
      <Flex justifyContent="space-between" alignItems="center" gap="30px">
        ...
        <div className={styles.dropdownContainer}>
          <DropdownMenu
            ...
            content={dropdownActionButtons}
          >
            <IconButton
              type="button"
              size="small"
              onClick={onToggleDropdown}
              aria-label={translate(I18N_KEYS.METHODS_MENU_TITLE)}
              title={translate(I18N_KEYS.METHODS_MENU_TITLE)}
              icon={<DotsIcon size={20} rotate={90} />}
            />
          </DropdownMenu>
        </div>
      </Flex>
