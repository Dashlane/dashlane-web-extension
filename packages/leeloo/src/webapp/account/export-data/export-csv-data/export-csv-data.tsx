...
const I18N_KEYS = {
    ...
    EXPORT_SUCCESS_MESSAGE: 'webapp_account_import_export_data_csv_success_message',
};
...
export const ExportCSVData = ({ reportError }: ExportCSVDataProps) => {
    ...
    return (<div>
      <FlexContainer sx={{
        ...
        <Heading as="h2" textStyle="ds.title.block.medium" color="ds.text.neutral.catchy" sx={{ marginTop: '16px' }}>
          {translate(I18N_KEYS.SUB_TITLE_CSV_EXPORT)}
        </Heading>
        <Paragraph textStyle="ds.body.standard.regular" color="ds.text.neutral.standard" sx={{ margin: '16px 0' }}>
          {translate(I18N_KEYS.EXPORT_HELP_CSV_TEXT)}
        </Paragraph>
        <Infobox sx={{
            marginBottom: '16px',
        }} mood="warning" title={translate(I18N_KEYS.HELP_WARNING_TEXT)}/>
        <Button intensity="quiet" mood="neutral" type="button" aria-label={translate(I18N_KEYS.EXPORT_CSV_BUTTON)} onClick={onExportCSVData}>
