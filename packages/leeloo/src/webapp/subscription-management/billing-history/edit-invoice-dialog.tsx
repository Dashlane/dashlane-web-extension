...
import { Dialog, jsx, TextField } from '@dashlane/design-system';
...
export const EditInvoiceDialog = ({ isOpen, onClose, onDownloadInvoice, }: EditInvoiceDialogProps) => {
    ...
    return (<Dialog title={translate(I18N_KEYS.TITLE)} closeActionLabel={translate(I18N_KEYS.CLOSE)} isOpen={isOpen} onClose={onClose} actions={{
            primary: {
      ...
      <div sx={{
        ...
        <TextField autoFocus data-testid="invoiceNameInput" label={translate(I18N_KEYS.INPUT_LABELS.NAME)} onChange={(event) => setName(event.target.value)} placeholder={translate(I18N_KEYS.PLACEHOLDERS.NAME)}/>
        <TextField data-testid="invoiceCompanyInput" label={translate(I18N_KEYS.INPUT_LABELS.COMPANY)} onChange={(event) => setCompany(event.target.value)} placeholder={translate(I18N_KEYS.PLACEHOLDERS.COMPANY)}/>
        <TextField label={translate(I18N_KEYS.INPUT_LABELS.ADDRESS)} onChange={(event) => setAddress(event.target.value)} placeholder={translate(I18N_KEYS.PLACEHOLDERS.ADDRESS)}/>
        <TextField label={translate(I18N_KEYS.INPUT_LABELS.TAX_ID)} onChange={(event) => setTaxId(event.target.value)} placeholder={translate(I18N_KEYS.PLACEHOLDERS.TAX_ID)}/>
      </div>
    </Dialog>);
};
