...
import { SharingPermissions } from "../sharing-permissions/sharing-permissions";
...
export const I18N_KEYS_PERMISSION_DIALOG = {
  ...
  EDIT_PERMISSIONS_TITLE:
    "webapp_shared_permissions_dialog_edit_permissions_title",
...
const { ConfirmRevoke, Failure, Permission, RevokeSuccess, Success } =
  PermissionDialogStep;
export interface Props {
  ...
  onDismiss: () => void;
  onSelectPermission: (permission: SharedPermission | "revoke") => void;
  onValidatePermission: () => void;
  permission: SharedPermission | "revoke";
...
export const PermissionDialog = ({
  ...
  isCollectionItemPermission = false,
  loading,
  onCancelRevoke,
  onConfirmRevoke,
  onDismiss,
  ...
  function renderPermissionsContent() {
    return (
      <div sx={{ w: "600px", mt: "30px" }}>
        <SharingPermissions
          isCollectionItemPermission={isCollectionItemPermission}
          canRevoke={true}
          shouldRevokeBeDisabled={shouldRevokeBeDisabled}
  ...
  function getPermissionDialogFooterProps() {
    return {
      primaryButtonTitle: translate(
        I18N_KEYS_PERMISSION_DIALOG.CHANGE_PERMISSIONS
      ),
      primaryButtonOnClick: onValidatePermission,
      primaryButtonProps: {
        disabled: permission === recipient.permission || loading,
      },
  ...
  return (
    <Dialog
      closeIconName={translate(I18N_KEYS_PERMISSION_DIALOG.CLOSE)}
      modalContentClassName={allIgnoreClickOutsideClassName}
      isOpen={isOpen}
      onClose={onDismiss}
