...
export const CollectionsOverviewCreate = () => {
    ...
    return (<div sx={{
      ...
      <Heading as="h1" textStyle="ds.title.section.medium" color="ds.text.neutral.catchy">
        {translate(I18N_KEYS.TITLE)}
      </Heading>
      <Paragraph color="ds.text.neutral.quiet">
        {translate(I18N_KEYS.DESCRIPTION)}
      </Paragraph>
      <Button layout="iconLeading" icon="ActionAddOutlined" onClick={handleClickOnCreate} sx={{ margin: 'auto' }}>
