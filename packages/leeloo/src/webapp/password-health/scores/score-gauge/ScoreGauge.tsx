...
export const ScoreGauge = ({ score, shouldAnimateText = false, }: ScoreGaugeProps) => {
    ...
    return (<div sx={{
      ...
      <Paragraph textStyle="ds.specialty.spotlight.large" as="span" sx={{
      ...
      <GridChild as={Paragraph} gridArea={'gauge'} size="medium" color="ds.text.neutral.quiet" sx={{
            marginTop: '136px',
