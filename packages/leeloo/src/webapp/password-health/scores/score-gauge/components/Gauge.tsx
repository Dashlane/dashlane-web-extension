...
export const Gauge = ({ score, showQueerColors = false }: GaugeProps) => {
  ...
  return (
    ...
    >
      ...
      />
      {showQueerColors ? (
        <g id="queerGroup" mask="url(#animatedMask)">
          <path
            stroke="#760888"
            strokeLinecap="round"
            strokeWidth="12"
          ...
          <path
            stroke="#014EFF"
            strokeWidth="12"
            d="M18.594 147a94 94 0 11175.405-46.614"
          />
          <path
            stroke="#018027"
            strokeWidth="12"
            d="M18.594 147a94 94 0 01162.812-94"
          />
          <path
            stroke="#FFEE01"
            strokeWidth="12"
            d="M18.594 147A94 94 0 01147.133 18.67"
          />
          <path
            stroke="#FF8D01"
            strokeWidth="12"
            d="M18.594 147A93.998 93.998 0 0199.749 6"
          />
          <path
            stroke="#E40404"
            strokeWidth="12"
            d="M18.594 147A93.998 93.998 0 0153 18.594"
          />
          <path
            stroke="#795018"
            strokeWidth="12"
            d="M18.594 147a93.998 93.998 0 01-.213-93.63"
          />
          <path
            fill="#010101"
            d="M13.398 150a6 6 0 1010.392-6l-10.392 6zm10.392-6A88 88 0 0112 99.55l-12-.061A99.998 99.998 0 0013.398 150l10.392-6z"
          />
        </g>
      ) : (
        <path
