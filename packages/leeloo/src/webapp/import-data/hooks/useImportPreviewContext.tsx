...
export const ImportPreviewContext =
  React.createContext<ImportPreviewContextValue>({
    preview: {
...
export const ImportPreviewContextProvider = ({
  children,
  ...
  const [previewDataHeaders, setPreviewDataHeaders] =
    useState<PreviewDataHeaders>([]);
...
export const useImportPreviewContext = () =>
  React.useContext(ImportPreviewContext);
