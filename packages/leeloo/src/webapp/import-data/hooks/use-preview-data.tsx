...
import { ImportFormats, ImportSource, PreviewPersonalDataErrorType, PreviewPersonalDataRequest, PreviewPersonalDataResult, } from '@dashlane/communication';
...
export interface UsePreviewData {
    ...
    previewFile: (importSource: ImportSource, password?: string) => Promise<PreviewPersonalDataResult>;
    resetState: () => void;
...
export const usePreviewData = (): UsePreviewData => {
    ...
    const makePreviewCommand = async (importSource: ImportSource, password?: string): Promise<PreviewPersonalDataRequest> => {
    ...
    const previewFile = async (importSource: ImportSource, password?: string): Promise<PreviewPersonalDataResult> => {
