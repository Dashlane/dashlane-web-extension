...
export const logImportFlowTerminated = (
  importSource: ImportSource,
  attemptedItemCount: number,
  isDirectImport: boolean
) => {
...
export const logDirectImportFailed = (
  backupFileType: BackupFileType,
  importSource: ImportSource,
