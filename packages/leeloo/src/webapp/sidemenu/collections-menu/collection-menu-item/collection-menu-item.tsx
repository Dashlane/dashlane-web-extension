...
export const CollectionMenuItem = ({
  collection,
  ...
  return (
    <MenuItem
      ...
      to={routes.userCollection(collection.id)}
      threeDotsComponent={
        <ActionsMenu
          collection={collection}
          sx={{ padding: "15px", borderRadius: "0", outlineOffset: "-2px" }}
          triggerButton={{
            mood: "neutral",
          }}
        />
    ...
    >
      <MenuItemContent
        ...
        collectionSpaceId={collection.spaceId}
        isPersonalSpaceDisabled={isPersonalSpaceDisabled}
