...
export const affectedDataTranslationKeyMap: Record<BreachLeakedDataType, string> = {
...
export const getFormattedLeakedDataTypes = (leakedDataTypes: BreachLeakedDataType[], translate: TranslatorInterface, omitPassword?: boolean): string => {
