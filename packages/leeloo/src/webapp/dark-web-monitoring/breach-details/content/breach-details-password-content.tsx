...
import { Eyebrow, InfoBox, jsx, PasswordInput } from '@dashlane/ui-components';
import { BreachLeakedDataType } from '@dashlane/communication';
import useTranslate from 'libs/i18n/useTranslate';
import { getFormattedLeakedDataTypes } from 'webapp/dark-web-monitoring/breach-details/helpers';
...
export const ContentPasswordSection = ({ passwords, leakedData, domain, }: ContentOtherSectionprops) => {
    ...
    return (<Fragment>
      <section className={styles.section}>
        ...
        {passwords.map((password) => (<PasswordInput key={password} hidePasswordTooltipText={translate(I18N_KEYS.PASSWORD_HIDE)} showPasswordTooltipText={translate(I18N_KEYS.PASSWORD_SHOW)} value={password} readOnly/>))}
        <InfoBox className={styles.adviceBox} title={domain === undefined
      ...
      {leakedData.length > 1 ? (<section className={styles.section}>
          <Eyebrow as="header" size="small" color="primaries.5" sx={{ marginBottom: '4px' }}>
