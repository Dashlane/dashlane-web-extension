...
import { Eyebrow, InfoBox, jsx } from '@dashlane/ui-components';
...
const I18N_KEYS = {
    ...
    ADVICE_REACH_OUT_CREDIT_CARD: 'webapp_darkweb_alert_advice_reach_out_credit_card',
...
export const ContentOtherSection = ({ isPasswordLeaked, isCreditCardLeaked, leakedData, domain, }: ContentOtherSectionprops) => {
    ...
    return (<section className={styles.section}>
      ...
      {isPasswordLeaked || isCreditCardLeaked ? (<InfoBox className={styles.adviceBox} title={isPasswordLeaked
                ? domain === undefined
