import { BreachDetailItemView, breachesApi, passwordHealthApi, } from '@dashlane/password-security-contracts';
...
export const useBreachDetails = (breachId: string): UseBreachDetails => {
    ...
    const { data: compromisedCredentialsIds } = useModuleQuery(passwordHealthApi, 'compromisedCredentialsIdsForBreach', { breachId });
    return {
        breach: data ?? null,
