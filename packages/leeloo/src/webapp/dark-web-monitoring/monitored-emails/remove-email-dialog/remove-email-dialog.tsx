...
const I18N_KEYS = {
  ...
  STOP_MONITORING_DIALOG_TITLE:
    "webapp_darkweb_email_stop_monitoring_dialog_title",
  STOP_MONITORING_DIALOG_DESCRIPTION:
    "webapp_darkweb_email_stop_monitoring_dialog_content_markup",
};
...
export const RemoveEmailDialog = ({
  email,
  handleOnRemoveEmail,
  handleOnCloseDialog,
}: RemoveEmailDialogProps) => {
  ...
  return (
    <SimpleDialog
      isOpen
      onRequestClose={handleOnCloseDialog}
      footer={
        <DialogFooter
          primaryButtonTitle={translate(I18N_KEYS.STOP_MONITORING_BUTTON)}
          primaryButtonOnClick={onRemoveEmail}
          secondaryButtonTitle={translate(I18N_KEYS.CANCEL_BUTTON)}
          secondaryButtonOnClick={handleOnCloseDialog}
          intent="danger"
        />
      }
      title={translate(I18N_KEYS.STOP_MONITORING_DIALOG_TITLE)}
    >
