import { Button, colors, jsx, Paragraph, Tooltip, } from '@dashlane/ui-components';
...
const I18N_KEYS = {
    BUSINESS_EMAIL_TOOLTIP_DESCRIPTION: 'webapp_darkweb_bussiness_email_monitoring_description_markup',
    BUSINESS_EMAIL_TOOLTIP_TITLE: 'webapp_darkweb_bussiness_email_monitoring_title',
...
export const AvatarWithTooltip = ({ email }: AvatarWithTooltipProps) => {
    ...
    const { setAsSeen } = useNotificationSeen(NotificationName.DWMb2bAutoEnrollTooltip);
    return (<Tooltip placement="left" trigger="persist" sx={{
            display: 'flex',
            flexDirection: 'column',
            padding: '16px',
            zIndex: 1,
        }} content={<>
          <Paragraph size="large" color={colors.white} sx={{
                textAlign: 'left',
                fontWeight: 'bold',
            }}>
          ...
          <Button size="small" sx={{ alignSelf: 'flex-end' }} type="button" onClick={setAsSeen}>
