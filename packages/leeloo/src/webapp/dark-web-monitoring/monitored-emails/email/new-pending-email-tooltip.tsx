...
export const NewPendingEmailTooltip = ({
  children,
  email,
  handleOnClosePendingNotification,
}: PropsWithChildren<NewPendingEmailTooltipProps>) => {
  return (
    <Tooltip
      data-testid="Pending notification tooltip"
      placement="bottom-start"
      trigger="persist"
      content={
        <PendingNotification
          email={email}
          handleOnDismiss={handleOnClosePendingNotification}
        />
      }
      sx={{
        minWidth: "376px",
