import { Button, colors, FlexContainer, Heading, jsx, LightBulbIcon, Paragraph, } from '@dashlane/ui-components';
...
export const PendingNotification = ({ email, handleOnDismiss, }: PendingNotificationProps) => {
    const { translate } = useTranslate();
    return (<FlexContainer flexDirection="column" alignItems="flex-start" sx={{
            textAlign: 'left',
            padding: '16px',
            width: '100%',
        }}>
      <FlexContainer flexWrap="nowrap" alignItems="center">
        ...
        <Heading size="x-small" sx={{ ml: '10px', fontWeight: '600', color: colors.black }}>
      ...
      <Button sx={{ mt: '32px', mr: '16px', alignSelf: 'flex-end' }} type="submit" onClick={handleOnDismiss}>
