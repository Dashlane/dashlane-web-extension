...
import { BreachesFilterCriterium, BreachesFirstTokenParams, BreachesSortCriterium, BreachItemView, BreachStatus, } from '@dashlane/communication';
import { carbonConnector } from 'libs/carbon/connector';
import { connectPagination, PaginationConfig } from 'libs/pagination/consumer';
import { PrivateBreachesBaseProps, PrivateBreachesComponent, } from './private-breaches.component';
...
const ConnectedPrivateBreaches = connectPagination(config, PrivateBreachesComponent);
...
export const PrivateBreaches = (props: PrivateBreachesBaseProps) => (<ConnectedPrivateBreaches tokenParams={breachesFirstTokenParams} {...props}/>);
