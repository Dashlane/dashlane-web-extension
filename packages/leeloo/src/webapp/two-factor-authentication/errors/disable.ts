...
const I18N_KEYS = {
    ...
    BAKCUP_CODE_NOT_VALID_ERROR: 'webapp_account_security_settings_two_factor_authentication_turn_off_authenticator_invalid_security_code',
    TWO_FACTOR_AUTHENTICATION_DISABLE_SUCCESS_ALERT: 'webapp_account_security_settings_disable_success',
    CLOSE_DIALOG: '_common_dialog_dismiss_button'
};
export const getTwoFactorAuthenticationCodeLogError = (errorCode: string | AuthenticationCode): TwoFactorAuthenticationErrorLog => {
