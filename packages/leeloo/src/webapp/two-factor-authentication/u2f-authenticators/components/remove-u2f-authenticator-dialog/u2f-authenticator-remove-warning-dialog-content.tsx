...
export const U2FAuthenticatorRemoveWarningDialogContent = ({
  handleClickOnSubmit,
  handleClickOnBack,
}: Props) => {
      ...
      <DialogBody>
        <Paragraph color={colors.dashGreen01}>
          ...
          <InfoBox
            severity="warning"
            size="small"
            title={translate(I18N_KEYS.WARNING_CONTENT)}
            sx={{ marginTop: "15px" }}
          />
        </Paragraph>
      </DialogBody>
      <DialogFooter
        primaryButtonTitle={translate(I18N_KEYS.WARNING_PRIMARY_BUTTON)}
        primaryButtonOnClick={handleClickOnSubmit}
        primaryButtonProps={{ theme: "warning" }}
        secondaryButtonTitle={translate(I18N_KEYS.WARNING_SECONDARY_BUTTON)}
