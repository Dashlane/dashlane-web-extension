...
import { TwoFactorAuthenticationEnableContainer } from "../containers/two-factor-authentication-enable-container";
import { TwoFactorAuthenticationDisableContainer } from "../containers/two-factor-authentication-disable-container";
...
export function useTwoFactorAuthentication(props: Props = {}): Type {
  ...
  const openTwoFactorAuthenticationDisablerDialog = useCallback(() => {
    ...
    openDialog(
      React.createElement(TwoFactorAuthenticationDisableContainer, {
        onDialogClose: () => {
          closeDialog();
  ...
  const openTwoFactorAuthenticationEnablerDialog = useCallback(() => {
    const onDialogUnlocked = () => {
      openDialog(
        React.createElement(TwoFactorAuthenticationEnableContainer, {
