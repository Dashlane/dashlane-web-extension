...
import { colors, DialogBody, DialogFooter, DialogTitle, jsx, MultiDeviceIcon, Paragraph, } from '@dashlane/ui-components';
import useTranslate from 'libs/i18n/useTranslate';
interface Props {
    onPrimaryButtonAction: () => void;
    onSecondaryButtonAction: () => void;
}
export const InsideExtensionDialog = ({ onPrimaryButtonAction, onSecondaryButtonAction, }: Props) => {
    ...
    const I18N_KEYS = {
        ...
        ENABLEMENT_DESCRIPTION: 'webapp_two_factor_authentication_enforcement_dialog_description_2',
    ...
    return (<>
      ...
      <DialogFooter primaryButtonTitle={translate(I18N_KEYS.ACTION)} primaryButtonOnClick={onPrimaryButtonAction} secondaryButtonTitle={translate(I18N_KEYS.LOGOUT)} secondaryButtonOnClick={onSecondaryButtonAction}/>
    </>);
};
