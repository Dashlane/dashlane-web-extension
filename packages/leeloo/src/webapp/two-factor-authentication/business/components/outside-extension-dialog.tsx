...
const I18N_KEYS = {
  BROWSER_NOT_SUPPORTED_DESCRIPTION:
    "webapp_two_factor_authentication_enforcement_dialog_unsupported_browser_desc_markup",
  BROWSER_NOT_SUPPORTED_TITLE:
    "webapp_two_factor_authentication_enforcement_dialog_unsupported_browser_title",
  BROWSER_SUPPORTED_DESCRIPTION:
    "webapp_two_factor_authentication_enforcement_dialog_supported_browser_desc",
  BROWSER_SUPPORTED_TITLE:
    "webapp_two_factor_authentication_enforcement_dialog_supported_browser_title",
  MOBILE_SUPPORTED_DESCRIPTION:
    "webapp_two_factor_authentication_enforcement_dialog_supported_mobile_desc",
  MOBILE_SUPPORTED_TITLE:
    "webapp_two_factor_authentication_enforcement_dialog_supported_mobile_title",
  COMPANY_REQUIREMENT:
    "webapp_two_factor_authentication_enforcement_dialog_description_1",
  DOWNLOAD_DASHLANE:
    "webapp_two_factor_authentication_enforcement_dialog_supported_browser_action",
...
const SupportedMobileBrowser = ({ onSecondaryButtonAction }: Props) => {
  ...
  return (
    <>
      <DialogTitle
        id="dialogTitle"
        title={translate(I18N_KEYS.MOBILE_SUPPORTED_TITLE)}
      />
      <DialogBody>
...
const UnsupportedBrowser = ({ onSecondaryButtonAction }: Props) => {
  ...
  return (
    <>
      ...
      <DialogTitle
        id="dialogTitle"
        title={translate(I18N_KEYS.BROWSER_NOT_SUPPORTED_TITLE)}
      />
      <DialogBody>
        <Paragraph color={colors.grey00}>
          {translate(I18N_KEYS.COMPANY_REQUIREMENT)}
        ...
        <Paragraph color={colors.grey00}>
          {translate.markup(
            I18N_KEYS.BROWSER_NOT_SUPPORTED_DESCRIPTION,
            undefined,
            {
              linkTarget: "_blank",
            },
...
const SupportedBrowser = ({ onSecondaryButtonAction }: Props) => {
  ...
  return (
    <>
      <DialogTitle
        id="dialogTitle"
        title={translate(I18N_KEYS.BROWSER_SUPPORTED_TITLE)}
      />
      <DialogBody>
      ...
      <DialogFooter
        ...
        primaryButtonOnClick={handleOnPrimaryAction}
        secondaryButtonTitle={translate(I18N_KEYS.LOGOUT)}
        secondaryButtonOnClick={onSecondaryButtonAction}
      />
    </>
...
export const OutsideExtensionDialog = (props: Props) => {
  ...
  return isSupportedBrowser() ? (
    <SupportedBrowser {...props} />
  ) : (
    <UnsupportedBrowser {...props} />
  );
};
