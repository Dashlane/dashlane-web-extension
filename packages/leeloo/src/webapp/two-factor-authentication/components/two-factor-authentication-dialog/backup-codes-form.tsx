...
import { BACKUP_CODES_FILENAME } from "../../constants";
const I18N_KEYS = {
  TITLE1:
    "webapp_account_security_settings_two_factor_authentication_backup_codes_title1",
  TITLE2:
    "webapp_account_security_settings_two_factor_authentication_backup_codes_title2",
  DESCRIPTION:
    "webapp_account_security_settings_two_factor_authentication_backup_codes_description",
  LIST_LABEL:
    "webapp_account_security_settings_two_factor_authentication_backup_codes_list_label",
  DOWNLOAD_BUTTON:
    "webapp_account_security_settings_two_factor_authentication_backup_codes_download_button",
