...
import { logTwoFactorAuthenticationDisableBackupCodePageView } from 'webapp/two-factor-authentication/logs/disable-flow-logs';
...
export const TwoFactorAuthenticationBackupCodeDialog = ({ handleClickOnSubmit, toggleAuthenticationCodeMode, handleClickOnBack, error, login, }: Props) => {
    ...
    return (<form onSubmit={formik.handleSubmit}>
      <DialogBody>
        <BackupCodeForm code={code} errorMessage={localErrorMessage} updateAuthenticatorCode={updateAuthenticatorCode} handleAuthenticatorModeClick={toggleAuthenticationCodeMode} login={login}/>
      </DialogBody>
      <DialogFooter primaryButtonTitle={translate(I18N_KEYS.AUTHENTICATOR_PRIMARY_BUTTON)} primaryButtonProps={{
            disabled: disableSubmit,
            type: 'button',
        }} primaryButtonOnClick={() => formik.handleSubmit()} secondaryButtonTitle={translate(I18N_KEYS.AUTHENTICATOR_SECONDARY_BUTTON)} secondaryButtonOnClick={handleClickOnBack}/>
    </form>);
};
