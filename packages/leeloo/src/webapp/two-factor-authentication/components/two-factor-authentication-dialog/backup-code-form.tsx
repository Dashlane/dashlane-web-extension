...
const I18N_KEYS = {
    BACKUP_TITLE: 'webapp_account_security_settings_two_factor_authentication_backup_code_title',
...
export const BackupCodeForm = ({ handleAuthenticatorModeClick, code, updateAuthenticatorCode, errorMessage, login, }: Props) => {
    ...
    return (<div sx={{
      ...
      <Paragraph color={colors.lightTheme.ds.text.inverse.quiet} sx={{
            marginBottom: '26px',
        }}>
        {translate(I18N_KEYS.BACKUP_CONTENT)}{' '}
      </Paragraph>
      <TextInput autoFocus={true} type="text" data-testid="two-factor-authentication-backup-code" fullWidth label={translate(I18N_KEYS.BACKUP_LABEL)} value={code} onChange={updateAuthenticatorCode} feedbackType={errorMessage ? 'error' : undefined} feedbackText={errorMessage ? translate(errorMessage) : undefined}/>
