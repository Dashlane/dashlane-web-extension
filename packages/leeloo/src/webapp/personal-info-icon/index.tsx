import { Icon, IconProps, jsx, mergeSx, ThemeUIStyleObject, } from '@dashlane/design-system';
import { Enum } from 'typescript-string-enums';
export const IconType = Enum('address', 'company', 'email', 'emailPro', 'identity', 'phone', 'phoneFax', 'phoneMobile', 'phoneWork', 'phoneWorkFax', 'phoneWorkMobile', 'website');
...
const PersonalInfoIcon = ({ className = '', iconSize, iconType }: Props) => {
    return (<div className={className} sx={mergeSx([SX_STYLES[iconSize], SX_STYLES.icon])}>
      <Icon name={iconTypeAssociation[iconType]} color="ds.text.brand.quiet" sx={ICON_STYLES[iconSize]}/>
    </div>);
};
