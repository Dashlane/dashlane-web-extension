...
const renderAddressForm = (lee: Lee, formRef: Ref<AddressForm>, signalEditedValues: () => void, currentSpaceId: string): JSX.Element => {
    ...
    return (<AddressForm lee={lee} currentValues={data} signalEditedValues={signalEditedValues} ref={formRef}/>);
};
