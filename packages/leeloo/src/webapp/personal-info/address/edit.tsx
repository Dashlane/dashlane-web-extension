...
import { AddressForm, AddressFormEditableValues, } from 'webapp/personal-info/address/form';
...
const renderAddressForm = (lee: Lee, item: Address, ref: Ref<AddressForm>, signalEditedValues: () => void): JSX.Element => {
    ...
    return (<AddressForm lee={lee} currentValues={data} signalEditedValues={signalEditedValues} ref={ref}/>);
};
...
const getDescription = (translateFn: TranslateFunction): string => translateFn(I18N_KEYS.ITEM_TYPE);
