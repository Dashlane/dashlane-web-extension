...
import { Country, IdentityTitle, VaultItemType, } from '@dashlane/vault-contracts';
import { Lee } from 'lee';
...
const renderIdentityForm = (lee: Lee, ref: Ref<IdentityForm>, signalEditedValues: () => void, currentSpaceId: string): JSX.Element => {
    const localeFormat: Country = Country[lee.globalState.locale.country] || Country.US;
