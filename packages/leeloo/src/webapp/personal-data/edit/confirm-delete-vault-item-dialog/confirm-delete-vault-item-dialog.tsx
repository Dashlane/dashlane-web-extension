...
export const ConfirmDeleteVaultItemDialog = ({ closeConfirmDeleteDialog, goToSharingAccess, isVisible, itemId, onDeletionSuccess, sharingStatus, translations, vaultItemType, isShared, isSharedViaUserGroup, isLastAdmin, }: ConfirmDeleteVaultItemDialogProps) => {
    ...
    if (cantDeleteReason && goToSharingAccess) {
        return (<CantDeleteDialog reason={cantDeleteReason} translations={translations} goToSharingAccess={goToSharingAccess} closeCantDeleteDialog={closeConfirmDeleteDialog}/>);
    }
    const onDelete = async () => {
        try {
            ...
            if (deletionResult.tag === DataStatus.Success) {
                showToast({
                    description: translations.deleteSuccessToast ??
    ...
    return (<ConfirmDeleteDialog closeConfirmDeleteDialog={closeConfirmDeleteDialog} onDeleteConfirm={onDelete} translations={translations}/>);
};
