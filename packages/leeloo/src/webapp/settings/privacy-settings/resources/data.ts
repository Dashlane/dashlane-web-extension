import {
  MAIL_TO_SUPPORT_GDPR_ACCESS,
  MAIL_TO_SUPPORT_GDPR_COMPLAINT,
  MAIL_TO_SUPPORT_GDPR_DATA_PORTABILITY,
  MAIL_TO_SUPPORT_GDPR_ERASURE,
  MAIL_TO_SUPPORT_GDPR_OBJECT,
  MAIL_TO_SUPPORT_GDPR_RECTIFICATION,
  MAIL_TO_SUPPORT_GDPR_RESTRICTION_PROCESSING,
...
const I18N_KEYS = {
  ...
  WITHDRAW_CONSENT_DESCRIPTION:
    "webapp_privacy_settings_withdraw_consent_description",
  ...
  RECTIFICATION_DESCRIPTION:
    "webapp_privacy_settings_rectification_description",
  RESTRICTION_PROCESSING_TITLE:
    "webapp_privacy_settings_restriction_processing_title",
  RESTRICTION_PROCESSING_DESCRIPTION:
    "webapp_privacy_settings_restriction_processing_description",
  DATA_PORTABILITY_TITLE: "webapp_privacy_settings_data_portability_title",
  DATA_PORTABILITY_DESCRIPTION:
    "webapp_privacy_settings_data_portability_description",
