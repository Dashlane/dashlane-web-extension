...
export const UpgradeDialogWork = ({ onClose }: UpgradeDialogWorkProps) => {
    ...
    return (<DialogContainer header={translate('webapp_sharing_center_work_dialog_header')} headerIconName="ItemCompanyOutlined" onClose={() => {
      ...
      <Button mood="brand" intensity="quiet" fullsize onClick={() => {
            logEvent(new UserCallToActionEvent({
                callToActionList: [CallToAction.AllOffers],
