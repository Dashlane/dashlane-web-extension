...
export const BottomPanelBar = ({ selectedGroups = [], selectedUsers = [], onClose, }: BottomPanelBarProps) => {
    ...
    return (<div sx={{
      ...
      <SharingButton sharing={{
        ...
        }} tooltipPlacement="top-start" text={translate(I18N_KEYS.SHARE_NEW_ITEM)} origin={Origin.ItemListView}/>
