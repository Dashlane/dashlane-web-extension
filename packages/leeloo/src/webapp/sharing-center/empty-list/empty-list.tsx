import { jsx, SharingCenterIcon } from '@dashlane/ui-components';
...
export const EmptyList = () => {
    ...
    return (<EmptyView icon={<SharingCenterIcon size={72} color="ds.text.neutral.quiet"/>} title={translate(I18N_KEYS.TITLE)}>
      <p className={styles.description}>{translate(I18N_KEYS.DESCRIPTION)}</p>
      <SharingButton hideIcon tooltipPlacement="bottom" text={translate(I18N_KEYS.EMPTY_CTA)} sharing={{
