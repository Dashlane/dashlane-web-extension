...
import { CollectionLogo } from "../../../sharing-notifications/collections/collection-logo";
import { CollectionItemView } from "./item-row";
import {
  useCollectionPermissionsForUser,
  useCollectionRoleForGroup,
} from "../../../sharing-invite/hooks/use-collection-permissions";
...
export const CollectionTitle = ({
  ...
  const roleLabelMood =
    role === SharedCollectionRole.Manager ? "brand" : "danger";
  return (
    <div
      sx={{
        display: "flex",
