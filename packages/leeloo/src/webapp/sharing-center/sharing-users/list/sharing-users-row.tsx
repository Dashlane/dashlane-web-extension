...
export const SharingUsersRow = ({ userLogin, itemCount, }: SharingUsersRowProps) => {
    ...
    const formatSharingUser = (): RowLinkProps => {
        return {
            ...
            data: [
              ...
              <AvatarWithAbbreviatedText email={userLogin} avatarSize={48} placeholderFontSize={24} placeholderTextType="firstTwoCharacters"/>
