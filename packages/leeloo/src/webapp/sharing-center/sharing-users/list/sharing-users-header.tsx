...
export const SharingUsersHeader = ({ updateUserSortDirection, currentSortDirection, }: SharingUsersHeaderProps) => {
    ...
    return (<div className={styles.contentHeader}>
      <ListHeader header={headerFields} onSort={onSort} options={getHeaderSortOptions()}/>
    </div>);
};
