...
export const GroupHeader = ({ updateGroupSortDirection, currentSortDirection, }: GroupHeaderProps) => {
    ...
    const onSort = React.useCallback((sortingOptions: SortingOptions<UserGroupSortField>) => {
    ...
    return (<div className={styles.groupHeader}>
      <Header header={headerFields} onSort={onSort} options={getHeaderSortOptions()}/>
    </div>);
};
