...
const I18N_KEYS = {
    ...
    BUTTON_GO_BACK_VAULT: 'webapp_account_security_settings_changemp_error_button_goback',
};
export const ChangeMasterPasswordFailure = ({ progressValue, onBack, }: Props) => {
    const { translate } = useTranslate();
    return (<Progress description={translate(I18N_KEYS.DESCRIPTION)} subdescription={translate(I18N_KEYS.SUB_DESCRIPTION)} animation={failureLottie} progressValue={progressValue}>
