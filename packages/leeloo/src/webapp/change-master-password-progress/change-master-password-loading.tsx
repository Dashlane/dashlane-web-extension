...
export const ChangeMasterPasswordLoading = ({ progressValue }: Props) => {
    ...
    return (<Progress description={translate(I18N_KEYS.DESCRIPTION)} subdescription={translate(I18N_KEYS.SUB_DESCRIPTION)} animation={loadingLottie} shouldLoopAnimation={true} progressValue={progressValue}/>);
};
