...
import { CarbonLifecycleEvent, LiveDataStatus, useCarbonLifecycleEvents, useCarbonLive, } from '@dashlane/carbon-api-consumers';
...
export function useChangeMasterPasswordProgress(): ChangeMPProgress {
    const [status, setStatus] = useState<ChangeMPProgressStatus>(ChangeMPProgressStatus.NOT_STARTED);
