...
const I18N_KEYS = {
    ...
    TIP_GENERATE_NEW_RECOVERY_KEY: "webapp_account_security_settings_tip_generate_new_recovery_key"
};
export const ChangeMasterPasswordSuccess = ({ progressValue, onDone, }: Props) => {
    const { translate } = useTranslate();
    return (<Progress description={translate(I18N_KEYS.DESCRIPTION)} animation={successLottie} progressValue={progressValue}>
      ...
      <Infobox className={styles.infoboxTip} title={translate(I18N_KEYS.TIP_GENERATE_NEW_RECOVERY_KEY)} mood="brand"/>
    </Progress>);
};
