import { VpnCapabilitySetting, VpnDisabledReason, } from '@dashlane/communication';
import { useShowB2BPaywall, useVpnCapabilitySetting } from 'webapp/vpn/hooks';
...
const checkReason = (vpnCapabilitySetting: VpnCapabilitySetting | null, reason: VpnDisabledReason) => !!vpnCapabilitySetting &&
...
export const useVpnPageAccess = (): VpnPageAccess | null => {
    ...
    const userHasVpnEnabled = !!vpnCapabilitySetting && vpnCapabilitySetting.hasVpnEnabled;
    const showVpnDisabledB2BTooltip = checkReason(vpnCapabilitySetting, VpnDisabledReason.InTeam);
    const showB2CPaywall = (checkReason(vpnCapabilitySetting, VpnDisabledReason.NotPremium) ||
