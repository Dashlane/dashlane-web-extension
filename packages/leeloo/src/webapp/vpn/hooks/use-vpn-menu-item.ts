...
const I18N_KEYS = {
    ...
    VPN_DISABLED_FOR_B2B_DESC: 'webapp_vpn_notification_disabled_for_b2b_description',
};
export const useVpnMenuItem = (isCollapsed: boolean, notificationClass: string) => {
    const vpnPageAccess = useVpnPageAccess();
    if (vpnPageAccess?.showVpnPage === undefined ||
    ...
    const { showVpnPage, showVpnMenuItem, vpnPaywallInfo, showVpnDisabledB2BTooltip, } = vpnPageAccess;
