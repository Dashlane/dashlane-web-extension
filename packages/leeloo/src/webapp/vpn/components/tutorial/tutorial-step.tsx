...
import { Icon, mergeSx, ThemeUIStyleObject } from "@dashlane/design-system";
import {
  colors,
  GridChild,
  GridContainer,
...
export const TutorialStep = ({
  actions,
  number = 1,
  status = TutorialStepStatus.INITIAL,
  title,
  options,
  children,
}: TutorialStepProps) => {
  const containerSx = options
    ...
    : layoutStyle;
  return (
    <GridContainer alignItems="center" gap="16px" sx={containerSx}>
