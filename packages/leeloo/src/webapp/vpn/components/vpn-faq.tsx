import { Accordion, colors, Eyebrow, jsx } from '@dashlane/ui-components';
import useTranslate from 'libs/i18n/useTranslate';
import { HOTSPOTSHIELD_SUPPORT_URL, VPN_FAQ_LINK, VPN_READ_MORE_LINK, } from './vpn-links-constants';
...
export const VpnFaq = () => {
    ...
    return (<section sx={{ marginTop: '32px' }}>
      <Eyebrow sx={{ color: colors.grey00 }}>
        {translate(I18N_KEYS.TITLE.key)}
      </Eyebrow>

      <Accordion sx={{ marginTop: '16px' }}>
        <VpnFaqSection summary={I18N_KEYS.GENERAL_SUMMARY} parts={[
            I18N_KEYS.GENERAL_DETAILS1,
            I18N_KEYS.GENERAL_DETAILS2_MARKUP,
        ]}/>
        <VpnFaqSection summary={I18N_KEYS.HOTSPOT_SUMMARY} parts={[I18N_KEYS.HOTSPOT_DETAILS]}/>
        <VpnFaqSection summary={I18N_KEYS.SUPPORT_SUMMARY} parts={[
