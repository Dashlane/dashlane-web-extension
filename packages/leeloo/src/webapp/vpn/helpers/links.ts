const DASHLANE_VPN_URL = "__REDACTED__";
const DASHLANE_SUPPORT_ARTICLE_URL = "__REDACTED__";
export const HOTSPOT_SHIELD_URL = "__REDACTED__";
...
const createSuppotArticleLink = (id: string, medium: string, source: string) =>
  `${DASHLANE_SUPPORT_ARTICLE_URL}/${id}?utmMedium=${medium}&amp;utmSource=${source}`;
export const VPN_READ_MORE_LINK = createSuppotArticleLink(
  "360001158385",
  VPN_FAQ_UTM_MEDIUM,
  UTM_SOURCE
);
export const VPN_FAQ_LINK = createSuppotArticleLink(
  "360000037900",
  VPN_FAQ_UTM_MEDIUM,
  UTM_SOURCE
);
export const VPN_LEARN_MORE = createSuppotArticleLink(
  "360000045439",
  VPN_UTM_MEDIUM,
  UTM_SOURCE
);
