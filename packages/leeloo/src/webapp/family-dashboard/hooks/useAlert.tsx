...
export const useAlert = (message: string, severity: AlertSeverity): UseAlert => {
    ...
    const alert = id ? (<PopupAlert id={id} message={message} onHide={hide} severity={severity}/>) : null;
