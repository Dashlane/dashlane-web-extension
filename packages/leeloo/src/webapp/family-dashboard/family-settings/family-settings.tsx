...
const I18N_KEYS = {
  ...
  RESET_INVITATION_LINK:
    "webapp_family_dashboard_settings_reset_invitation_link",
};
interface Props {
...
export const FamilySettings = ({
  ...
  const renderButton = (toggle: () => void) => (
    ...
    >
      ...
      <span
        className={classnames(styles.dropdownButtonIcon, {
  ...
  const renderDropdownContent = () => (
    <div className={styles.list}>
      <ButtonDropdown
        label={translate(I18N_KEYS.MY_ACCOUNT)}
        data-close-dropdown
        icon={<SettingsIcon />}
        onClick={onMyAccountClick}
      />
      <ButtonDropdown
        label={translate(I18N_KEYS.RESET_INVITATION_LINK)}
        data-close-dropdown
        icon={<RefreshIcon />}
