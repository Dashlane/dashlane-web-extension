...
export const FamilyHeader = ({ spots, invitationLink, statusCode, }: FamilyHeaderProps) => {
    ...
    return (<header className={styles.familyHeader}>
      ...
      <div className={styles.headerContent}>
        <div className={styles.linkContainer}>
          ...
          <div className={styles.linkInputContainer}>
            <input aria-label={translate(I18N_KEYS.COPY_LINK)} className={styles.link} readOnly value={invitationLink} ref={linkInputEl} onClick={selectInputLink}/>
