...
export const CopyButton = ({ onClick, isLinkCopied }: CopyButtonProps) => {
    ...
    return (<Button type="button" nature="primary" size="large" className={isLinkCopied ? styles.copiedButton : styles.copyButton} disabled={isLinkCopied} onClick={onClick}>
      <div className={styles.icon}>
        {isLinkCopied ? (<CheckIcon color={colors.white}/>) : (<LinkIcon color={colors.white}/>)}
      </div>
