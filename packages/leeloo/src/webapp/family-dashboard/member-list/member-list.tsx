    ...
    <>
      <ul>
        <MemberRow
          key={admin.userId}
          member={admin}
          onRemoveAction={handleOpenRemoveDialog}
        />
      ...
      {memberToRemove && memberToRemove.showDialog && memberToRemove.member ? (
        <RemoveMemberDialog
          memberLogin={memberToRemove.member.login}
          handleRemoveMember={onRemoveMember}
          handleOnCancel={onCancelRemoveMember}
        />
      ) : null}
    </>
  );
