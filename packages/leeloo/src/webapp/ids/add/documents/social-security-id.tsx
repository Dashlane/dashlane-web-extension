...
import { SocialSecurityIdFormFields } from "../../types";
...
const I18N_KEYS = {
  SUCCESS_DEFAULT:
    "webapp_id_creation_socialsecurity_alert_add_success_default",
...
const countryToKeys = (country: Country) =>
  COUNTRIES_I18N_KEYS[country] ?? {
...
export const SocialSecurityIdAddPanel = ({ lee, listRoute }: Props) => {
  ...
  return (
    <AddPanel<SocialSecurityIdFormFields>
      ...
      header={(country) => (
        <Header
          title={translate(countryToKeys(country).title)}
          country={country}
