...
import { FiscalIdFormFields } from 'webapp/ids/types';
...
export const FiscalIdAddPanel = ({ lee, listRoute }: Props) => {
    ...
    return (<AddPanel<FiscalIdFormFields> initialValues={initialValues} listRoute={listRoute} reportError={lee.reportError} countryToKeys={countryToKeys} type={VaultItemType.FiscalId} requiredProperty="fiscalNumber" header={(country) => (<Header title={translate(countryToKeys().title)} country={country} type={VaultItemType.FiscalId}/>)}>
