...
const I18N_KEYS = {
  ...
  PASSPORTS_FALLBACK_TYPE:
    "webapp_sidemenu_search_results_ids_passports_fallback_type",
  ID_CARDS_FALLBACK: "webapp_sidemenu_search_results_ids_id_cards_fallback",
  ID_CARDS_FALLBACK_TYPE:
    "webapp_sidemenu_search_results_ids_id_cards_fallback_type",
  FISCAL_NUMBERS_FALLBACK:
    "webapp_sidemenu_search_results_ids_fiscal_ids_fallback",
  FISCAL_NUMBERS_FALLBACK_TYPE:
    "webapp_sidemenu_search_results_ids_fiscal_ids_fallback_type",
  DRIVER_LICENSES_FALLBACK:
    "webapp_sidemenu_search_results_ids_driver_licences_fallback",
  DRIVER_LICENSES_FALLBACK_TYPE:
    "webapp_sidemenu_search_results_ids_driver_licences_fallback_type",
  SOCIAL_SECURITY_IDS_FALLBACK:
    "webapp_sidemenu_search_results_ids_social_security_ids_fallback",
  SOCIAL_SECURITY_IDS_FALLBACK_TYPE:
    "webapp_sidemenu_search_results_ids_social_security_ids_fallback_type",
};
const FALLBACK_TEXT = {
...
export const getFallbackIdTitle = (
...
export function getBritishSpellingLabel(
  label: string,
  locale: string,
  country: Country
) {
