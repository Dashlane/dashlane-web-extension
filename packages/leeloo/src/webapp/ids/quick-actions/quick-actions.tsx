...
const I18N_KEYS = {
    ...
    IDS_SOCIAL_SECURITY_COPY: 'webapp_ids_social_security_ids_social_security_id_copy',
    IDS_SOCIAL_SECURITY_COPY_SUCCESSFUL: 'webapp_ids_social_security_ids_social_security_id_copy_successfull',
    IDS_DRIVER_LICENSE_COPY: 'webapp_ids_driver_licences_driver_licence_copy',
    IDS_DRIVER_LICENSE_COPY_SUCCESSFUL: 'webapp_ids_driver_licences_driver_licence_copy_successfull',
    IDS_PASSPORT_COPY: 'webapp_ids_passports_passport_copy',
    IDS_PASSPORT_COPY_SUCCESSFUL: 'webapp_ids_passports_passport_copy_successfull',
    IDS_FISCAL_ID_COPY: 'webapp_ids_fiscal_ids_fiscal_id_copy',
    IDS_FISCAL_ID_COPY_SUCCESSFUL: 'webapp_ids_fiscal_ids_fiscal_id_copy_successfull',
};
interface Props {
    itemId: string;
    copyValue: string;
...
export const QuickActions = ({ itemId, copyValue, editRoute, reportError, variant, type, }: Props) => {
    ...
    return (<span onClick={(evt) => {
      ...
      <Button layout="iconOnly" aria-label={translate(labels[type].copy)} title={translate(labels[type].copy)} icon="ActionCopyOutlined" onClick={handleCopyClick} type="button" size="small" intensity="supershy"/>
      {!searchVariant ? (<Button layout="iconOnly" aria-label={translate(I18N_KEYS.IDS_EDIT_DOCUMENT)} title={translate(I18N_KEYS.IDS_EDIT_DOCUMENT)} icon="ActionEditOutlined" onClick={handleEditClick} type="button" size="small" intensity="supershy"/>) : null}
    </span>);
};
