...
import { getBritishSpellingLabel } from "../../helpers";
import { useIdData } from "../../hooks/use-id-data";
...
export const WithData = ({
  ...
  } = useIdDeleteModal(setDialogActive);
  if (status === DataStatus.Success && item !== undefined) {
    return (
      <EditPanel
        itemId={id}
        item={item}
        copySuccessKey={I18N_KEYS.COPY_SUCCESS}
        deleteAlertTranslation={I18N_KEYS.ALERT_DELETE}
        deleteDialogTitle={I18N_KEYS.DIALOG_DELETE_TITLE}
        editAlertTranslation={I18N_KEYS.ALERT_EDIT}
        initialValues={item}
        listRoute={listRoute}
        ...
        getDescription={(country) =>
          getBritishSpellingLabel(
            translate(I18N_KEYS.HEADER_DESCRIPTION),
            translate.getLocale(),
            country
          )
        }
