...
export const PanelWrapper = (props: Props) => {
  ...
  return (
    <Panel
      ...
      ignoreCloseOnEscape={isDialogActive || displayDiscardAlert}
      onNavigateOut={handleClickOutside}
    >
      <Component
        listRoute={baseRoute}
      ...
      {displayDiscardAlert ? (
        <ConfirmDiscardDialog
          onDismissClick={() => setDisplayDiscardAlert(false)}
          onConfirmClick={confirmDiscardDialog}
        />
      ) : null}
    </Panel>
  );
