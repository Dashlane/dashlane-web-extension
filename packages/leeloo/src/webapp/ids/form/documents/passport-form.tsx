...
const PassportFormComponent = ({ variant, handleCopy, country }: Props) => {
    ...
    return (<>
      ...
      <TextInputField name="issuePlace" label={translate(I18N_KEYS.PLACE_OF_ISSUE_LABEL)} placeholder={translate(I18N_KEYS.PLACE_OF_ISSUE_PLACEHOLDER)} disabled={!!isDisabled}/>
