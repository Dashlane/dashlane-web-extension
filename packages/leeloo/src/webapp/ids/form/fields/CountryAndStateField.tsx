...
import { useCountryStates } from "../../hooks/use-static-states";
...
const CountryAndStateFieldComponent = (props: Props) => {
  ...
  const { initialValues, setFieldValue, values } =
    useFormikContext<BaseIdUpdateModel>();
  ...
  const options = React.useMemo(
    () => (stateOptions ? [defaultOption, ...stateOptions] : undefined),
