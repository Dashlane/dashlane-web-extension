...
const getAdditionnalDescription = (criticalityStatus: Criticality, monthsDiff: number, I18N_KEYS: Record<string, string>, translate: TranslatorInterface) => {
...
export const getDescriptions = (expirationDateString: string, I18N_KEYS: Record<string, string>, isExpiredLabelforIDEnabled: boolean, translate: TranslatorInterface): [
    string?,
    Criticality?
] => {
    ...
    const additionalDescription = criticalityStatus
        ? getAdditionnalDescription(criticalityStatus, monthsDiff, I18N_KEYS, translate)
