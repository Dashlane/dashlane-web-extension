...
import { DSTheme, Flex, Paragraph } from "@dashlane/design-system";
...
import { getFallbackIdTitle } from "../../helpers";
import { IdVaultItemType, ThumbnailSize } from "../../types";
import { IdThumbnail } from "../thumbnails/id-thumbnail";
...
const AdditionalDescription = ({
  ...
  return text ? (
    <Paragraph
      ...
      sx={bold ? { fontWeight: "600" } : {}}
    >
      {text}
    </Paragraph>
  ) : null;
};
export const IdItemArticleComponent = ({
  itemId,
  title,
  description,
  country,
