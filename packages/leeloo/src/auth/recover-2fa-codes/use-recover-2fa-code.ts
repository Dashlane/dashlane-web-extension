import { Request2FaCodesByPhoneErrorCodes, userVerificationApi, } from '@dashlane/authentication-contracts';
import { useModuleCommands } from '@dashlane/framework-react';
import { isSuccess } from '@dashlane/framework-types';
export type Recover2FAErrors = Request2FaCodesByPhoneErrorCodes | 'UnknownError';
interface UseRecover2FaCodesParams {
    onSuccess: () => void;
    onError: (error: Recover2FAErrors) => void;
}
export const useRecover2faCodes = ({ onSuccess, onError, }: UseRecover2FaCodesParams) => {
