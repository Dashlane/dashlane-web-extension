...
import { Flex, Heading, Infobox, Paragraph } from "@dashlane/design-system";
...
const I18N_KEYS = {
  ...
  INSTRUCTIONS: {
    ...
    COMPLETE_LOGIN:
      "webapp_recover_otp_disable_2fa_instructions_complete_login",
    OPEN_WEB_APP:
      "webapp_recover_otp_disable_2fa_instructions_open_web_app_markup",
    OPEN_SECURITY_SETTINGS:
      "webapp_recover_otp_disable_2fa_instructions_open_security_settings_markup",
    TOGGLE_OFF: "webapp_recover_otp_disable_2fa_instructions_toggle_off_markup",
    ENTER_SECOND_CODE:
      "webapp_recover_otp_disable_2fa_instructions_enter_second_code",
  ...
  return (
    <div>
      <Flex flexDirection="column" gap="16px">
        ...
        <Infobox
          title={translate(I18N_KEYS.WARNING.TITLE)}
          mood="warning"
          description={
