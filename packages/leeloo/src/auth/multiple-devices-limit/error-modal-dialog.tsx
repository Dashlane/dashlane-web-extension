...
export const UnlinkMultipleDevicesErrorModal = ({
  errorStage,
}: ErrorModalProps) => {
  ...
  return (
    ...
    >
      ...
      <DialogFooter
        primaryButtonTitle={translate(I18N_KEYS.TRY_AGAIN)}
        primaryButtonOnClick={onHandleOnTryAgain}
        secondaryButtonTitle={translate(I18N_KEYS.SEE_PREMIUM)}
        secondaryButtonOnClick={onHandleGoToPremiumPlan}
      />
    </Dialog>
  );
};
