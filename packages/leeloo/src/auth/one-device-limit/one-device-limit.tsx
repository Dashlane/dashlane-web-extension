...
const I18N_KEYS = {
  ...
  UNLINK_PREVIOUS_DEVICE:
    "webapp_login_one_device_limit_unlink_previous_device",
  HEADER_V2: "webapp_login_one_device_limit_header_V2",
  FEATURE_COPY: "webapp_login_one_device_limit_feature_copy_markup",
  FEATURE_UNLIMITED_DEVICES:
    "webapp_login_one_device_limit_feature_unlimited_devices",
  FEATURE_DARK_WEB_MONITORING:
    "webapp_login_one_device_limit_feature_dark_web_monitoring",
...
const FeatureRow: React.FC<FeatureRowProps> = ({ iconName, children }) => (
...
const OneDeviceLimit = ({ previousDevice }: OneDeviceLimitProps) => {
  ...
  return (
    <>
        ...
        >
          ...
          <Flex flexWrap="nowrap" gap="16px">
            ...
            <Button
              mood="neutral"
              intensity="quiet"
              onClick={handleShowUnlinkPreviousDeviceDialog}
              size="large"
            >
      ...
      <UnlinkPreviousDeviceDialog
        isOpen={unlinkDialogShown}
        handleOnCancel={handleHideUnlinkPreviousDeviceDialog}
        handleOnConfirm={handleConfirmUnlinkDevice}
        handleOnGetUnlimitedAccess={handleGetUnlimitedAccess}
        previousDeviceInfo={previousDevice}
      />
    </>
  );
};
