...
export const DeviceToDeviceAuthentication = ({ loginEmail, passphrase, deviceToDeviceStep, error, }: Omit<AuthenticationFlowContracts.AuthenticationFlowDeviceToDeviceAuthenticationView, 'step'>) => {
    const getCurrentStep = () => {
        switch (deviceToDeviceStep) {
            case AuthenticationFlowContracts.DeviceToDeviceAuthenticationFlowStep
                .DisplayInstructions:
                return <DeviceTransferInstructions loginEmail={loginEmail}/>;
            case AuthenticationFlowContracts.DeviceToDeviceAuthenticationFlowStep
                .LoadingPassphrase:
                return <DeviceTransferLoading step="LOADING_PASSPHRASE"/>;
            case AuthenticationFlowContracts.DeviceToDeviceAuthenticationFlowStep
                .DisplayPassphrase:
                return (<DeviceTransferPassphrase loginEmail={loginEmail} passphrase={passphrase}/>);
            case AuthenticationFlowContracts.DeviceToDeviceAuthenticationFlowStep
                .LoadingAccount:
