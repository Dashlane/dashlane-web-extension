...
const I18N_ERROR_KEYS: Record<AuthenticationFlowContracts.DeviceToDeviceAuthenticationErrors, string> = {
...
type DeviceTransferErrorProps = Pick<AuthenticationFlowContracts.AuthenticationFlowDeviceToDeviceAuthenticationView, 'error'>;
...
export const DeviceTransferError = ({ error }: DeviceTransferErrorProps) => {
    ...
    return (<WebappLoginLayout>
      ...
      <FlexContainer flexDirection="column" alignItems="center">
        ...
        {shouldDisplayContactSupport({ error }) ? (<Button fullsize mood="neutral" intensity="quiet" sx={{ marginTop: '8px' }} onClick={() => openUrl(DASHLANE_CONTACT_SUPPORT_WITH_CHATBOT)}>
