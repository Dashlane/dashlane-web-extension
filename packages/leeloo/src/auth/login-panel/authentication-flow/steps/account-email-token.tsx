...
export const AccountEmailToken = ({ loginEmail, error, isLoading, isDashlaneAuthenticatorAvailable, resendEmailToken, switchToDashlaneAuthenticator, submitEmailToken, clearInputError, prefilledToken, onClearPrefilledToken, }: Props) => {
    ...
    return (<WebappLoginLayout>
      ...
      <form onSubmit={handleSubmit}>
        <SecurityCodeInput title={translate(I18N_KEYS.SECURITY_CODE_DESCRIPTION)} securityToken={emailToken} maxLength={SECURITY_TOKEN_MAX_LENGTH} onTokenInputChange={onTokenInputChange} errorMessage={error
            ...
            : undefined}/>
        <Button type="submit" id="extng-submit-email-token-button" data-testid="login-button" isLoading={isLoading} disabled={emailToken.length < EMAIL_TOKEN_MINIMAL_LENGTH} size="large" fullsize sx={{ marginTop: '16px' }}>
      ...
      <div>
        ...
        {isDashlaneAuthenticatorAvailable ? (<FlexContainer flexDirection="column" sx={{ marginTop: '24px' }}>
