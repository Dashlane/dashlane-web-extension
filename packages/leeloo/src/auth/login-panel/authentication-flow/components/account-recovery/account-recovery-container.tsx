...
import {
  AccountRecoveryWithKeyDialog,
  AdminAssistedRecoveryDialog,
  ChooseAccountRecoveryMethodDialog,
} from "./account-recovery-dialogs";
...
export const AccountRecoveryContainer = ({
  onClose,
  masterPassword,
  isAccountRecoveryKeyAvailable,
  isAdminAssistedRecoveryAvailable,
  existingAdminAssistedRecoveryStatus,
}: Props) => {
  if (isAccountRecoveryKeyAvailable && !isAdminAssistedRecoveryAvailable) {
    return <AccountRecoveryWithKeyDialog onClose={onClose} />;
  } else if (
    (!isAccountRecoveryKeyAvailable && isAdminAssistedRecoveryAvailable) ||
    ...
    return (
      <AdminAssistedRecoveryDialog
        ...
        existingARStatus={existingAdminAssistedRecoveryStatus}
      />
    );
  } else if (
    isAccountRecoveryKeyAvailable &&
