...
export const Navigation = () => {
    ...
    return (<FlexContainer justifyContent="flex-end" alignItems="center" sx={{ alignSelf: 'end', marginRight: '80px', marginTop: '40px' }}>
      <Paragraph color="ds.text.neutral.quiet">
        {translate(I18N_KEYS.CREATE_AN_ACCOUNT)}
      </Paragraph>
      <Button sx={{ marginLeft: '15px' }} type="button" intensity="quiet" onClick={redirectToAccountCreation}>
