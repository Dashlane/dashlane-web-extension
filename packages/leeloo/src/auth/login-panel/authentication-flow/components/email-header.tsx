...
const I18N_KEYS = {
  LOGIN_WITH_A_DIFFERENT_ACCOUNT:
    "webapp_login_form_password_fieldset_log_in_different_account",
};
export const EmailHeader = ({ selectedEmail }: Props) => {
  ...
  const switchAccountEmailDescription = translate(
    I18N_KEYS.LOGIN_WITH_A_DIFFERENT_ACCOUNT
  );
