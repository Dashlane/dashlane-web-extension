...
import { CheckIcon, colors, Heading, jsx, Paragraph, } from '@dashlane/ui-components';
...
const I18N_KEYS = {
    ACCOUNT_RECOVERY_MARKETING_HEADER: 'webapp_account_recovery_marketing_heading',
    ACCOUNT_RECOVERY_MARKETING_SUBHEADER: 'webapp_account_recovery_marketing_subheading',
...
export const AccountRecoveryMarketingContainer = ({ step, }: AccountRecoveryMarketingContainerProps) => {
    ...
    switch (step) {
        case AccountRecoveryStep.VERIFY_ACCOUNT:
            iconStateStep1 = (<div className={classnames(styles.stepIcon, styles.stepActive)}>1</div>);
            iconStateStep2 = (<div className={classnames(styles.stepIcon, styles.stepNonActive)}>
          2
        </div>);
            iconStateStep3 = (<div className={classnames(styles.stepIcon, styles.stepNonActive)}>
          3
        </div>);
        ...
        case AccountRecoveryStep.CREATE_MASTER_PASSWORD:
            iconStateStep1 = (<div className={classnames(styles.stepIcon, styles.stepChecked)}>
          <CheckIcon size={16} color={colors.white}/>
        </div>);
            iconStateStep2 = (<div className={classnames(styles.stepIcon, styles.stepActive)}>2</div>);
            iconStateStep3 = (<div className={classnames(styles.stepIcon, styles.stepNonActive)}>
          3
        </div>);
        ...
        case AccountRecoveryStep.ACCOUNT_RECOVERY_REQUEST:
          ...
          <CheckIcon size={16} color={colors.white}/>
            ...
            iconStateStep2 = (<div className={classnames(styles.stepIcon, styles.stepChecked)}>
          <CheckIcon size={16} color={colors.white}/>
        </div>);
            iconStateStep3 = (<div className={classnames(styles.stepIcon, styles.stepActive)}>3</div>);
            textColorStep1 = colors.dashGreen02;
        ...
        <div className={styles.marketingInner}>
          ...
          <div className={styles.stepsContainer}>
            <div className={styles.step}>
              {iconStateStep1}
              <Paragraph sx={{ padding: '12px' }} size="large" color={textColorStep1}>
            ...
            <div className={styles.step}>
              {iconStateStep2}
              <Paragraph sx={{ padding: '12px' }} size="large" color={textColorStep2}>
            ...
            <div className={styles.step}>
              {iconStateStep3}
              <Paragraph sx={{ padding: '12px' }} size="large" color={textColorStep3}>
