    ...
    return (<BaseMarketingContainer>
      <div className={styles.marketingContent}>
        <div className={styles.marketingInner}>
          <Paragraph color="ds.text.neutral.catchy" textStyle="ds.specialty.brand.medium" style={{ marginBottom: '24px' }}>
            {translate(I18N_KEYS.TITLE)}
          </Paragraph>
          <Paragraph className={styles.subtitle} color="ds.text.neutral.standard">
