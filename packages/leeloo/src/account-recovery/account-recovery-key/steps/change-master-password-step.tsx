...
import { FlexContainer, KeyIcon, Link } from '@dashlane/ui-components';
...
const I18N_KEYS = {
    ...
    PASSWORD_FIELD_LABEL: 'login_account_recovery_key_create_password_step_password_field_label',
    PASSWORD_FIELD_PLACEHOLDER: 'login_account_recovery_key_create_password_step_password_field_placeholder',
    CONFIRM_PASSWORD_FIELD_LABEL: 'login_account_recovery_key_create_password_step_confirm_password_field_label',
    CONFIRM_PASSWORD_FIELD_PLACEHOLDER: 'login_account_recovery_key_create_password_step_confirm_password_field_placeholder',
};
interface Props {
...
export const ChangeMasterPasswordStep = ({ onSubmit, onCancel }: Props) => {
    ...
    const handleShowPasswordTips = (event: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    return (<FlexContainer sx={{ flexDirection: 'column', alignItems: 'start', textAlign: 'left' }}>
      <PasswordTipsDialog showPasswordTipsDialog={showPasswordTips} handleDismiss={() => {
            setShowPasswordTips(false);
        }}/>
      <KeyIcon color="ds.text.brand.quiet" size={72}/>
      ...
      <Link href="#" role="button" onClick={handleShowPasswordTips} sx={{
            display: 'block',
            margin: '0 0 24px 0',
      ...
      <CreatePasswordForm onDismiss={handleCancel} onSubmit={handleSubmit} primaryButtonTitle={translate(I18N_KEYS.CONTINUE_BUTTON)} secondaryButtonTitle={translate(I18N_KEYS.CANCEL_BUTTON)} createPasswordInputLabel={translate(I18N_KEYS.PASSWORD_FIELD_LABEL)} createPasswordPlaceholderLabel={translate(I18N_KEYS.PASSWORD_FIELD_PLACEHOLDER)} confirmPasswordInputLabel={translate(I18N_KEYS.CONFIRM_PASSWORD_FIELD_LABEL)} confirmPasswordPlaceholderLabel={translate(I18N_KEYS.CONFIRM_PASSWORD_FIELD_PLACEHOLDER)}/>
    </FlexContainer>);
};
