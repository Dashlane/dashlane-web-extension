...
import { HELPCENTER_CANNOT_LOGIN_SECURITY_CODE_URL, LOGIN_URL_SEGMENT, } from 'app/routes/constants';
...
export const AccountTotp = ({ error, isLoading, submitTotp, changeTwoFactorAuthenticationOtpType, cancelAccountRecoveryKey, clearInputError, login, }: Props) => {
    ...
    return (<form onSubmit={handleSubmit}>
      <SecurityCodeInput title={translate(I18N_KEYS.SECURITY_CODE_DESCRIPTION)} securityToken={twoFactorAuthenticationOtpValue} maxLength={SECURITY_TOKEN_MAX_LENGTH} onTokenInputChange={onTokenInputChange} errorMessage={error
            ...
            : undefined}/>
      {showSyncDevicesHelp ? (<Infobox sx={{ marginTop: '24px' }} title={translate.markup(I18N_KEYS.SYNC_DEVICES_INFOBOX, {
      ...
      <div sx={{
        ...
        <Button type="submit" data-testid="submitTotp" isLoading={isLoading} disabled={twoFactorAuthenticationOtpValue.length < OTP_MAX_LENGTH}>
