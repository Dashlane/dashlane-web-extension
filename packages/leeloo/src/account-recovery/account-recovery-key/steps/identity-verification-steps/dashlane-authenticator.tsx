...
import { FlexContainer, Link, LoadingIcon, Paragraph, } from '@dashlane/ui-components';
...
interface Props extends Pick<AuthenticationFlowContracts.AuthenticationFlowDashlaneAuthenticatorView, 'error'> {
...
export const DashlaneAuthenticator = ({ cancelAccountRecoveryKey, error, resendPushNotification, switchToEmailToken, }: Props) => {
    ...
    return (<>
      ...
      {!error ? (<LoadingIcon data-testid="dashlane-authenticator-loading-icon" size="88px" color="ds.container.expressive.brand.catchy.active" sx={{
                margin: '32px 0px',
            }}/>) : (<FlexContainer flexDirection="column" sx={{ margin: '32px 0px' }}>
          <div>
          ...
          <Paragraph size="small" color="ds.text.danger.quiet" sx={{
                ...paragraphStyle,
                marginTop: '16px ',
            }}>
            {translate(error
      ...
      <FlexContainer flexDirection="row">
        <Paragraph color="ds.text.neutral.quiet" sx={{ ...paragraphStyle, paddingRight: '4px' }}>
      ...
      <div sx={{
        ...
        {!error ? null : (<Button onClick={handleResendPushNotification}>
