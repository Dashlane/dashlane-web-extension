...
} from "./identity-verification-steps";
const I18N_KEYS = {
  VERIFY_YOUR_IDENTITY_STEP_TITLE: "login_verify_your_identity_step_title",
};
export const VerifyYourIdentityStep = (props: { login: string }) => {
  ...
  const identityVerificationFlowStatus = useModuleQuery(
    IdentityVerificationFlowContracts.identityVerificationFlowApi,
      ...
      case "EmailTokenStep":
        return (
          <AccountEmailToken
            ...
            cancelAccountRecoveryKey={cancelRecoveryFlow}
            {...identityVerificationFlowStatus.data}
          />
        );
