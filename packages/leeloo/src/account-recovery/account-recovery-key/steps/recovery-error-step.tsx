...
import { accountRecoveryKeyApi, RecoveryFlowView, } from '@dashlane/account-recovery-contracts';
import { Button, Heading, Icon, jsx, Paragraph } from '@dashlane/design-system';
import { useModuleCommands } from '@dashlane/framework-react';
import { FlowStep, UseKeyErrorName, UserUseAccountRecoveryKeyEvent, } from '@dashlane/hermes';
...
export const RecoveryErrorStep = ({ error }: Props) => {
    ...
    useEffect(() => {
        logEvent(new UserUseAccountRecoveryKeyEvent({
            ...
            useKeyErrorName: error === 'WRONG_RECOVERY_KEY_ERROR'
    ...
    return (<FlexContainer sx={{
      ...
      <Icon name="FeedbackFailOutlined" size="large" color="ds.text.danger.quiet" sx={{ marginBottom: '48px', width: '62px', height: '62px' }}/>
