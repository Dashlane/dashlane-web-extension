...
export const RecoveryRequestPanel = ({
  dispatchGlobal,
  ...
  return (
    <div className={styles.recoveryRequestPanelContainer}>
      <div className={styles.content}>
        ...
        <div className={styles.inner}>
          ...
          <Flex sx={{ marginTop: "40px" }} justifyContent="space-between">
            <Link
              className={styles.previousStepContainer}
              to={routes.userCreateMasterPassword}
              replace
            >
              <BackIcon size={14} />
            ...
            >
              {isLoading ? (
                ...
                translate(I18N_KEYS.RECOVERY_REQUEST_CONFIRM_LABEL)
              )}
            </Button>
          </Flex>
        </div>
