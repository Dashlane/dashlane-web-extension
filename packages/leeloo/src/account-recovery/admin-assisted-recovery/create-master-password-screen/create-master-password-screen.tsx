...
export const CreateMasterPasswordScreen = ({ lee }: Props) => {
  ...
  const [showCreateMasterPasswordError, setShowCreateMasterPasswordError] =
    React.useState("");
  ...
  return (
    <div className={styles.panelsContainer}>
      <AccountRecoveryMarketingContainer
        step={AccountRecoveryStep.CREATE_MASTER_PASSWORD}
      />
      <CreateMasterPasswordPanel
        dispatchGlobal={lee.dispatchGlobal}
        onSubmit={createNewMasterPassword}
        createMPForAccountRecovery={true}
        showCreateMasterPasswordError={showCreateMasterPasswordError}
      />
